...
const Footer = () => {
  ...
  return (
    <footer style={{ background: "#030810", borderTop: "1px solid rgba(34,211,238,0.15)" }}>
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-14">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-cyan-400 text-xs font-['Cairo']">الامين</p>
              </div>
            </div>
            <p className="text-cyan-400 text-sm font-semibold font-['Inter'] mb-1">{t("footer.tagline")}</p>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/20 bg-cyan-500/5">
              <i className="ri-shield-check-line text-cyan-400 text-xs" />
              <span className="text-cyan-400 text-xs font-['JetBrains_Mono']">{t("footer.operated")}</span>
            </div>
          </div>
            ...
            <div className="space-y-2.5">
              {[
                ...
                <a key={link.key} href={link.href} onClick={(e) => { e.preventDefault(); scrollTo(link.href); }}
                  className="block text-gray-500 text-sm hover:text-cyan-400 transition-colors duration-200 cursor-pointer font-['Inter']">
                  <i className="ri-arrow-right-s-line mr-1 text-cyan-400/40" />
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-gray-600 text-xs hover:text-cyan-400 transition-colors cursor-pointer font-['Inter']">{t("footer.privacy")}</a>
            <span className="text-gray-700">|</span>
            <a href="#" className="text-gray-600 text-xs hover:text-cyan-400 transition-colors cursor-pointer font-['Inter']">{t("footer.terms")}</a>
          </div>
        </div>
      </div>
    </footer>
