...
export const entityMeta: Record<EntityType, { name: string; nameAr: string; icon: string; color: string; category: string; categoryAr: string }> = {
  hotel:       { name: "Grand Palace Hotel",           nameAr: "فندق القصر الكبير",          icon: "ri-hotel-line",           color: "#22D3EE", category: "Hotel Intelligence",      categoryAr: "الاستخبارات الفندقية" },
  "car-rental":{ name: "National Car Rental Co.",      nameAr: "شركة الوطنية لتأجير السيارات",icon: "ri-car-line",             color: "#22D3EE", category: "Car Rental Monitoring",   categoryAr: "مراقبة تأجير السيارات" },
  mobile:      { name: "National Telecom",             nameAr: "الاتصالات الوطنية",           icon: "ri-sim-card-line",        color: "#22D3EE", category: "Mobile Operators",        categoryAr: "مشغلو الاتصالات" },
  municipality:{ name: "Capital Municipality",         nameAr: "بلدية العاصمة",               icon: "ri-government-line",      color: "#22D3EE", category: "Municipality Registry",   categoryAr: "سجل البلديات" },
  ...
  health:      { name: "National Hospital",            nameAr: "المستشفى الوطني",             icon: "ri-heart-pulse-line",     color: "#F87171", category: "Health Interactions",     categoryAr: "التفاعلات الصحية" },
  ...
  transport:   { name: "National Transport Authority", nameAr: "هيئة النقل الوطنية",          icon: "ri-bus-line",             color: "#FB923C", category: "Public Transport",        categoryAr: "النقل العام" },
...
export const kpiByType: Record<EntityType, KpiCard[]> = {
  hotel: [
    { key: "bookings",  label: "Total Bookings",  labelAr: "إجمالي الحجوزات",  value: "1,284", delta: "+12%", deltaUp: true,  icon: "ri-calendar-check-line",  color: "#22D3EE", action: "Submit Booking",   actionAr: "إرسال حجز" },
    ...
    { key: "checkouts", label: "Check-Outs Today",labelAr: "تسجيل خروج اليوم", value: "38",    delta: "+3",   deltaUp: true,  icon: "ri-logout-box-line",      color: "#FB923C", action: "Submit Check-Out", actionAr: "إرسال تسجيل خروج" },
  ],
  "car-rental": [
    { key: "bookings",  label: "Bookings Today",  labelAr: "حجوزات اليوم",     value: "203",   delta: "+18%", deltaUp: true,  icon: "ri-calendar-line",        color: "#22D3EE", action: "Submit Booking",   actionAr: "إرسال حجز" },
    ...
    { key: "returns",   label: "Returns Today",   labelAr: "إعادات اليوم",     value: "178",   delta: "-12",  deltaUp: false, icon: "ri-arrow-go-back-line",   color: "#FB923C", action: "Submit Return",    actionAr: "إرسال إعادة" },
  ],
  mobile: [
    { key: "simsales",  label: "SIM Sales",       labelAr: "مبيعات الشريحة",   value: "3,412", delta: "+8%",  deltaUp: true,  icon: "ri-sim-card-line",        color: "#22D3EE", action: "Submit SIM Sale",  actionAr: "إرسال بيع شريحة" },
    ...
    { key: "deactivations",label:"Deactivations", labelAr: "إلغاء التفعيل",    value: "124",   delta: "-3%",  deltaUp: false, icon: "ri-close-circle-line",    color: "#F87171", action: "Submit Deactivation",actionAr:"إرسال إلغاء" },
  ...
  municipality: [
    { key: "leases",    label: "New Leases",      labelAr: "عقود جديدة",       value: "312",   delta: "+9%",  deltaUp: true,  icon: "ri-home-line",            color: "#22D3EE", action: "Submit Lease",     actionAr: "إرسال عقد" },
    ...
    { key: "terminations",label:"Terminations",   labelAr: "الإنهاءات",         value: "47",    delta: "-5",   deltaUp: false, icon: "ri-close-line",           color: "#F87171", action: "Submit Termination",actionAr:"إرسال إنهاء" },
  ...
  payment: [
    ...
    { key: "wire",      label: "Wire Transfers",  labelAr: "التحويلات البنكية", value: "1,203", delta: "+4%",  deltaUp: true,  icon: "ri-send-plane-line",      color: "#22D3EE", action: "Submit Transfer",  actionAr: "إرسال تحويل" },
    { key: "flagged",   label: "Flagged",         labelAr: "المُبلَّغ عنها",   value: "18",    delta: "+3",   deltaUp: false, icon: "ri-flag-line",            color: "#F87171", action: "Submit Flag",      actionAr: "إرسال تنبيه" },
  ...
  borders: [
    ...
    { key: "visas",     label: "Visas Issued",    labelAr: "تأشيرات صادرة",    value: "1,234", delta: "+9%",  deltaUp: true,  icon: "ri-passport-line",        color: "#22D3EE", action: "Submit Visa",      actionAr: "إرسال تأشيرة" },
    { key: "overstay",  label: "Overstay Alerts", labelAr: "تنبيهات تجاوز",    value: "23",    delta: "+2",   deltaUp: false, icon: "ri-alarm-warning-line",   color: "#F87171", action: "Submit Alert",     actionAr: "إرسال تنبيه" },
  ],
  health: [
    { key: "patients",  label: "Registrations",   labelAr: "التسجيلات",        value: "1,847", delta: "+7%",  deltaUp: true,  icon: "ri-user-heart-line",      color: "#F87171", action: "Submit Patient",   actionAr: "إرسال مريض" },
    { key: "emergency", label: "Emergency Cases", labelAr: "حالات طارئة",      value: "34",    delta: "+5",   deltaUp: false, icon: "ri-heart-pulse-line",     color: "#FB923C", action: "Submit Emergency", actionAr: "إرسال طارئ" },
    ...
    { key: "discharges",label: "Discharges",      labelAr: "الخروج من المستشفى",value:"891",   delta: "+3%",  deltaUp: true,  icon: "ri-door-open-line",       color: "#22D3EE", action: "Submit Discharge", actionAr: "إرسال خروج" },
  ],
  utility: [
    ...
    { key: "modifications",label:"Modifications", labelAr: "التعديلات",         value: "234",   delta: "+3%",  deltaUp: true,  icon: "ri-settings-line",        color: "#22D3EE", action: "Submit Modification",actionAr:"إرسال تعديل" },
    { key: "terminations",label:"Terminations",   labelAr: "الإنهاءات",         value: "67",    delta: "-4",   deltaUp: false, icon: "ri-close-circle-line",    color: "#F87171", action: "Submit Termination",actionAr:"إرسال إنهاء" },
  ...
  transport: [
    { key: "journeys",  label: "Journeys Today",  labelAr: "رحلات اليوم",      value: "42,891",delta: "+9%",  deltaUp: true,  icon: "ri-bus-line",             color: "#FB923C", action: "Submit Journey",   actionAr: "إرسال رحلة" },
    { key: "taxi",      label: "Taxi Bookings",   labelAr: "حجوزات تاكسي",     value: "8,234", delta: "+14%", deltaUp: true,  icon: "ri-taxi-line",            color: "#22D3EE", action: "Submit Taxi",      actionAr: "إرسال تاكسي" },
    { key: "flagged",   label: "Flagged Routes",  labelAr: "مسارات مُبلَّغة",  value: "12",    delta: "+2",   deltaUp: false, icon: "ri-flag-line",            color: "#F87171", action: "Submit Flag",      actionAr: "إرسال تنبيه" },
  ...
  education: [
    ...
    { key: "visaext",   label: "Visa Extensions", labelAr: "تمديدات التأشيرة", value: "891",   delta: "+7%",  deltaUp: true,  icon: "ri-passport-line",        color: "#22D3EE", action: "Submit Extension", actionAr: "إرسال تمديد" },
    ...
    { key: "dropouts",  label: "Dropout Flags",   labelAr: "تنبيهات الانسحاب", value: "23",    delta: "+1",   deltaUp: false, icon: "ri-alert-line",           color: "#F87171", action: "Submit Flag",      actionAr: "إرسال تنبيه" },
  ],
  employment: [
    ...
    { key: "empchange", label: "Employer Changes",labelAr: "تغييرات صاحب العمل",value:"1,203", delta: "+5%",  deltaUp: true,  icon: "ri-exchange-line",        color: "#22D3EE", action: "Submit Change",    actionAr: "إرسال تغيير" },
    ...
    { key: "cancellations",label:"Cancellations", labelAr: "الإلغاءات",         value: "234",   delta: "-3%",  deltaUp: false, icon: "ri-close-circle-line",    color: "#F87171", action: "Submit Cancellation",actionAr:"إرسال إلغاء" },
  ...
  ecommerce: [
    ...
    { key: "highvalue", label: "High-Value Tx",   labelAr: "معاملات عالية القيمة",value:"234", delta: "+7%",  deltaUp: false, icon: "ri-money-dollar-circle-line",color:"#F87171",action:"Submit High-Value",actionAr:"إرسال عالي القيمة" },
    { key: "merchants", label: "New Merchants",   labelAr: "تجار جدد",         value: "47",    delta: "+9%",  deltaUp: true,  icon: "ri-store-line",           color: "#22D3EE", action: "Submit Merchant",  actionAr: "إرسال تاجر" },
  ],
  social: [
    ...
    { key: "keywords",  label: "Keyword Alerts",  labelAr: "تنبيهات الكلمات",  value: "234",   delta: "+18%", deltaUp: false, icon: "ri-search-eye-line",      color: "#F87171", action: "Submit Alert",     actionAr: "إرسال تنبيه" },
...
export const eventFeedByType: Record<EntityType, EventFeedItem[]> = {
  hotel: [
    ...
    { id: "e2", type: "Booking Created",typeAr: "إنشاء حجز",     color: "#22D3EE", ref: "HTL-2025-04890", detail: "Reservation for Sarah Johnson — 3 nights, Suite 512",  detailAr: "حجز لسارة جونسون — 3 ليالٍ، جناح 512",          time: "8 min ago",  status: "accepted" },
    ...
    { id: "e4", type: "Check-Out",      typeAr: "تسجيل خروج",    color: "#FB923C", ref: "HTL-2025-04888", detail: "Guest Fatima Al-Zadjali — Room 301, Early Departure",  detailAr: "نزيلة فاطمة الزدجالية — غرفة 301، مغادرة مبكرة", time: "22 min ago", status: "accepted" },
    ...
    { id: "e7", type: "Booking Cancelled",typeAr:"إلغاء حجز",    color: "#F87171", ref: "HTL-2025-04885", detail: "Cancellation: Reservation #BK-88190, Refund Pending",  detailAr: "إلغاء: حجز #BK-88190، استرداد معلق",            time: "1 hr ago",   status: "rejected" },
  ...
  "car-rental": [
    ...
    { id: "e2", type: "Rental Booking", typeAr: "حجز تأجير",     color: "#22D3EE", ref: "CAR-2025-07233", detail: "Nissan Patrol (OM-67890) — 7 days, Muscat Airport",    detailAr: "نيسان باترول (OM-67890) — 7 أيام، مطار مسقط",   time: "11 min ago", status: "accepted" },
    ...
    { id: "e4", type: "Vehicle Drop-off",typeAr:"إعادة مركبة",   color: "#FB923C", ref: "CAR-2025-07231", detail: "Honda Accord (OM-33221) returned — Damage Report Filed",detailAr: "هوندا أكورد (OM-33221) أُعيدت — تقرير أضرار",    time: "42 min ago", status: "pending"  },
  ...
  mobile: [
    ...
    { id: "e4", type: "Roaming Active", typeAr: "تفعيل تجوال",   color: "#22D3EE", ref: "MOB-2025-19231", detail: "International roaming enabled — UAE, KSA, UK",         detailAr: "تفعيل التجوال الدولي — الإمارات، السعودية، UK",  time: "29 min ago", status: "accepted" },
    { id: "e5", type: "SIM Deactivation",typeAr:"إلغاء شريحة",  color: "#F87171", ref: "MOB-2025-19230", detail: "Postpaid SIM deactivated — Account #AC-88234",         detailAr: "إلغاء شريحة مدفوعة — حساب #AC-88234",           time: "47 min ago", status: "accepted" },
  ...
  municipality: [
    ...
    { id: "e2", type: "Lease Renewal",  typeAr: "تجديد إيجار",   color: "#22D3EE", ref: "MUN-2025-03420", detail: "Renewal — Apt 4B, Ruwi, Tenant: Al-Farsi Family",     detailAr: "تجديد — شقة 4B، الروي، مستأجر: عائلة الفارسي",  time: "18 min ago", status: "accepted" },
    ...
    { id: "e4", type: "Lease Termination",typeAr:"إنهاء إيجار",  color: "#F87171", ref: "MUN-2025-03418", detail: "Early termination — Office 3F, CBD, Muscat",          detailAr: "إنهاء مبكر — مكتب 3F، المركز التجاري، مسقط",    time: "52 min ago", status: "accepted" },
  ...
  payment: [
    ...
    { id: "e3", type: "Currency Exchange",typeAr:"صرف عملات",     color: "#22D3EE", ref: "PAY-2025-88232", detail: "USD 50,000 → OMR — Exchange rate 0.385",              detailAr: "50,000 دولار → ريال — سعر الصرف 0.385",          time: "21 min ago", status: "accepted" },
    { id: "e4", type: "Flagged Transaction",typeAr:"معاملة مُبلَّغة",color:"#F87171",ref:"PAY-2025-88231",detail:"Suspicious pattern — Multiple small transfers",        detailAr: "نمط مشبوه — تحويلات صغيرة متعددة",               time: "38 min ago", status: "rejected" },
  ...
  borders: [
    ...
    { id: "e3", type: "Visa Issued",    typeAr: "إصدار تأشيرة",  color: "#22D3EE", ref: "BRD-2025-44889", detail: "Tourist visa — 30 days, Passport: IN-4523891",        detailAr: "تأشيرة سياحية — 30 يوماً، جواز: IN-4523891",     time: "12 min ago", status: "accepted" },
    { id: "e4", type: "Overstay Alert", typeAr: "تنبيه تجاوز",   color: "#F87171", ref: "BRD-2025-44888", detail: "Visa expired 3 days ago — Passport: PK-8823401",      detailAr: "انتهت التأشيرة منذ 3 أيام — جواز: PK-8823401",   time: "28 min ago", status: "pending"  },
  ...
  health: [
    { id: "e1", type: "Patient Registration",typeAr:"تسجيل مريض",color:"#F87171",ref:"HLT-2025-22341",detail:"New patient — Ahmed Al-Rashidi, DOB: 1985-03-12",       detailAr: "مريض جديد — أحمد الراشدي، تاريخ الميلاد: 1985-03-12",time:"3 min ago", status:"accepted"},
    { id: "e2", type: "Emergency Admission",typeAr:"قبول طارئ",  color: "#FB923C", ref: "HLT-2025-22340", detail: "Trauma case — Male, 34, Road accident, ICU",          detailAr: "حالة صدمة — ذكر، 34 عاماً، حادث طريق، العناية",  time: "11 min ago", status: "accepted" },
    ...
    { id: "e4", type: "Patient Discharge",  typeAr:"خروج مريض",  color: "#22D3EE", ref: "HLT-2025-22338", detail: "Discharged after 4 days — Ward 3B, Bed 12",           detailAr: "خروج بعد 4 أيام — جناح 3B، سرير 12",             time: "39 min ago", status: "accepted" },
  ...
  utility: [
    ...
    { id: "e2", type: "Service Modified",   typeAr: "تعديل خدمة", color: "#22D3EE", ref: "UTL-2025-11233", detail: "Tariff upgrade — Account #AC-77234, Commercial",      detailAr: "ترقية التعريفة — حساب #AC-77234، تجاري",          time: "19 min ago", status: "accepted" },
    ...
    { id: "e4", type: "Service Terminated", typeAr: "إنهاء خدمة", color: "#F87171", ref: "UTL-2025-11231", detail: "Disconnection — Shop 12, Muttrah, Non-payment",       detailAr: "قطع الخدمة — محل 12، مطرة، عدم الدفع",           time: "48 min ago", status: "accepted" },
  ...
  transport: [
    { id: "e1", type: "Bus Journey",    typeAr: "رحلة حافلة",    color: "#FB923C", ref: "TRN-2025-55234", detail: "Route 1 — Muscat → Seeb, 47 passengers",             detailAr: "خط 1 — مسقط → السيب، 47 راكباً",                 time: "2 min ago",  status: "accepted" },
    { id: "e2", type: "Taxi Booking",   typeAr: "حجز تاكسي",     color: "#22D3EE", ref: "TRN-2025-55233", detail: "Taxi #TX-8823 — Airport to Qurum, 18.4 km",          detailAr: "تاكسي #TX-8823 — المطار إلى القرم، 18.4 كم",     time: "8 min ago",  status: "accepted" },
    { id: "e3", type: "Route Flagged",  typeAr: "مسار مُبلَّغ",  color: "#F87171", ref: "TRN-2025-55232", detail: "Unusual pattern — Route 7, repeated stops",           detailAr: "نمط غير معتاد — خط 7، توقفات متكررة",            time: "22 min ago", status: "pending"  },
    ...
    { id: "e5", type: "Bus Journey",    typeAr: "رحلة حافلة",    color: "#FB923C", ref: "TRN-2025-55230", detail: "Route 5 — Ruwi → Qurum, 62 passengers",              detailAr: "خط 5 — الروي → القرم، 62 راكباً",                 time: "51 min ago", status: "accepted" },
  ],
  education: [
    ...
    { id: "e2", type: "Visa Extension", typeAr: "تمديد تأشيرة",  color: "#22D3EE", ref: "EDU-2025-08233", detail: "Student visa extended 1 year — Passport: IN-7823401", detailAr: "تمديد تأشيرة طالب سنة — جواز: IN-7823401",        time: "17 min ago", status: "accepted" },
    ...
    { id: "e5", type: "Dropout Flagged",typeAr: "تنبيه انسحاب",  color: "#F87171", ref: "EDU-2025-08230", detail: "No attendance 30+ days — Student #ST-33219",          detailAr: "غياب 30+ يوماً — طالب #ST-33219",                 time: "1.1 hr ago", status: "pending"  },
  ],
  employment: [
    ...
    { id: "e2", type: "Employer Change", typeAr: "تغيير صاحب عمل",color:"#22D3EE", ref: "EMP-2025-33233", detail: "Transfer — Al-Rashidi Group → Oman Oil Company",      detailAr: "نقل — مجموعة الراشدي → شركة النفط العُمانية",     time: "16 min ago", status: "accepted" },
    ...
    { id: "e4", type: "Permit Cancellation",typeAr:"إلغاء تصريح", color: "#F87171", ref: "EMP-2025-33231", detail: "Permit cancelled — Employer request, #WP-77891",      detailAr: "إلغاء تصريح — طلب صاحب العمل، #WP-77891",        time: "44 min ago", status: "accepted" },
  ...
  ecommerce: [
    ...
    { id: "e3", type: "High-Value Tx",   typeAr: "معاملة عالية القيمة",color:"#F87171",ref:"ECM-2025-77232",detail:"OMR 8,500 — Jewelry purchase, single transaction",   detailAr: "8,500 ريال — شراء مجوهرات، معاملة واحدة",         time: "23 min ago", status: "pending"  },
    { id: "e4", type: "Merchant Registration",typeAr:"تسجيل تاجر",color:"#22D3EE", ref: "ECM-2025-77231", detail: "New merchant — Al-Amri Dates LLC, Category: Food",    detailAr: "تاجر جديد — شركة العامري للتمور، فئة: غذاء",      time: "37 min ago", status: "accepted" },
  ...
  social: [
    ...
    { id: "e2", type: "Keyword Alert",   typeAr: "تنبيه كلمة مفتاحية",color:"#F87171",ref:"SOC-2025-99233",detail:"High-priority keyword detected — Public post",       detailAr: "كلمة مفتاحية عالية الأولوية — منشور عام",         time: "7 min ago",  status: "pending"  },
...
export const navItems = [
  ...
  { key: "hotel",       icon: "ri-hotel-line",         labelEn: "Hotel Events",      labelAr: "أحداث الفنادق",     route: "/dashboard/hotel-events",           group: "modules" },
  { key: "car-rental",  icon: "ri-car-line",           labelEn: "Car Rental",        labelAr: "تأجير السيارات",    route: "/dashboard/car-rental-events",      group: "modules" },
  { key: "mobile",      icon: "ri-sim-card-line",      labelEn: "Mobile Operators",  labelAr: "مشغلو الاتصالات",   route: "/dashboard/mobile-events",          group: "modules" },
  { key: "municipality",icon: "ri-government-line",    labelEn: "Municipality",      labelAr: "البلديات",           route: "/dashboard/municipality-events",    group: "modules" },
  { key: "financial",   icon: "ri-bank-card-line",     labelEn: "Financial Services",labelAr: "الخدمات المالية",   route: "/dashboard/financial-events",       group: "modules" },
  { key: "border",      icon: "ri-passport-line",      labelEn: "Border Intelligence",labelAr: "استخبارات الحدود", route: "/dashboard/border-intelligence",    group: "modules" },
  { key: "utility",     icon: "ri-flashlight-line",    labelEn: "Utility Events",    labelAr: "أحداث المرافق",     route: "/dashboard/utility-events",         group: "modules" },
  { key: "transport",   icon: "ri-bus-line",           labelEn: "Transport Intel",   labelAr: "استخبارات النقل",   route: "/dashboard/transport-intelligence", group: "modules" },
  { key: "healthcare",  icon: "ri-heart-pulse-line",   labelEn: "Healthcare Events", labelAr: "أحداث الرعاية الصحية", route: "/dashboard/healthcare-events",    group: "modules" },
  { key: "tourism",     icon: "ri-map-2-line",         labelEn: "Tourism Events",    labelAr: "أحداث السياحة",     route: "/dashboard/tourism-events",         group: "modules" },
  { key: "marine",      icon: "ri-anchor-line",        labelEn: "Marine Events",     labelAr: "أحداث البحرية",     route: "/dashboard/marine-events",          group: "modules" },
  { key: "postal",      icon: "ri-mail-send-line",     labelEn: "Postal Events",     labelAr: "أحداث البريد",      route: "/dashboard/postal-events",          group: "modules" },
  { key: "education",   icon: "ri-graduation-cap-line",labelEn: "Education Events",  labelAr: "أحداث التعليم",     route: "/dashboard/education-events",       group: "modules" },
  { key: "employment",  icon: "ri-briefcase-line",     labelEn: "Employment Registry",labelAr: "سجل التوظيف",      route: "/dashboard/employment-registry",    group: "modules" },
  { key: "ecommerce",   icon: "ri-shopping-cart-line", labelEn: "E-Commerce Intel",  labelAr: "استخبارات التجارة", route: "/dashboard/ecommerce-intelligence", group: "modules" },
  { key: "social",      icon: "ri-global-line",        labelEn: "Social Intel",      labelAr: "استخبارات التواصل",route: "/dashboard/social-intelligence",    group: "modules" },
  { key: "customs",     icon: "ri-ship-line",          labelEn: "Customs & Cargo",   labelAr: "الجمارك والشحن",    route: "/dashboard/customs-cargo",          group: "modules" },
  ...
  { key: "patterns",   icon: "ri-git-branch-line",    labelEn: "Pattern Engine",    labelAr: "محرك الأنماط",       route: "/dashboard/pattern-engine",         group: "admin" },
  { key: "predictive", icon: "ri-line-chart-line",    labelEn: "Predictive Analytics",labelAr: "التحليلات التنبؤية", route: "/dashboard/predictive-analytics",   group: "admin" },
  { key: "person360",  icon: "ri-user-search-line",   labelEn: "Person 360°",          labelAr: "ملف الشخص 360°",     route: "/dashboard/person-360",             group: "admin" },
  { key: "identity-fusion", icon: "ri-fingerprint-line", labelEn: "Identity Fusion",    labelAr: "دمج الهويات",        route: "/dashboard/identity-fusion",        group: "admin" },
  { key: "link-analysis",  icon: "ri-git-branch-line",  labelEn: "Link Analysis",      labelAr: "تحليل الروابط",      route: "/dashboard/link-analysis",          group: "admin" },
  ...
  { key: "mobile-field",  icon: "ri-smartphone-line",     labelEn: "AMEEN Mobile",       labelAr: "أمين موبايل",        route: "/mobile-field",                     group: "admin" },
  ...
  { key: "api-portal",   icon: "ri-code-s-slash-line",   labelEn: "Developer Portal",   labelAr: "بوابة المطورين",     route: "/dashboard/api-portal",             group: "admin" },
  { key: "brand",        icon: "ri-shield-star-line",    labelEn: "Brand Identity",     labelAr: "الهوية البصرية",     route: "/dashboard/brand-identity",         group: "admin" },
  { key: "compliance",  icon: "ri-shield-check-line",  labelEn: "Compliance Scorecard", labelAr: "بطاقة الامتثال",  route: "/dashboard/compliance-scorecard",   group: "admin" },
  { key: "dossier",     icon: "ri-file-shield-2-line", labelEn: "Digital Dossier",      labelAr: "الملف الرقمي",    route: "/dashboard/digital-dossier",        group: "admin" },
  { key: "geoint",      icon: "ri-earth-line",         labelEn: "GEOINT",               labelAr: "الاستخبارات الجغرافية", route: "/dashboard/geoint",            group: "admin" },
  { key: "threat-intel",    icon: "ri-bug-line",           labelEn: "Threat Intel Feed",    labelAr: "تغذية استخبارات التهديد", route: "/dashboard/threat-intel",    group: "admin" },
  ...
  { key: "executive",       icon: "ri-bar-chart-box-line", labelEn: "Executive Dashboard",  labelAr: "لوحة القيادة التنفيذية", route: "/dashboard/executive",       group: "admin" },
