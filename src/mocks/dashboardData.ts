...
export const entityMeta: Record<EntityType, { name: string; nameAr: string; icon: string; color: string; category: string; categoryAr: string }> = {
  hotel:       { name: "Grand Palace Hotel",           nameAr: "فندق القصر الكبير",          icon: "ri-hotel-line",           color: "#D4A84B", category: "Hotel Intelligence",      categoryAr: "الاستخبارات الفندقية" },
  "car-rental":{ name: "National Car Rental Co.",      nameAr: "شركة الوطنية لتأجير السيارات",icon: "ri-car-line",             color: "#D4A84B", category: "Car Rental Monitoring",   categoryAr: "مراقبة تأجير السيارات" },
  mobile:      { name: "National Telecom",             nameAr: "الاتصالات الوطنية",           icon: "ri-sim-card-line",        color: "#D4A84B", category: "Mobile Operators",        categoryAr: "مشغلو الاتصالات" },
  municipality:{ name: "Capital Municipality",         nameAr: "بلدية العاصمة",               icon: "ri-government-line",      color: "#D4A84B", category: "Municipality Registry",   categoryAr: "سجل البلديات" },
...
export const kpiByType: Record<EntityType, KpiCard[]> = {
  hotel: [
    { key: "bookings",  label: "Total Bookings",  labelAr: "إجمالي الحجوزات",  value: "1,284", delta: "+12%", deltaUp: true,  icon: "ri-calendar-check-line",  color: "#D4A84B", action: "Submit Booking",   actionAr: "إرسال حجز" },
  ...
  "car-rental": [
    { key: "bookings",  label: "Bookings Today",  labelAr: "حجوزات اليوم",     value: "203",   delta: "+18%", deltaUp: true,  icon: "ri-calendar-line",        color: "#D4A84B", action: "Submit Booking",   actionAr: "إرسال حجز" },
  ...
  mobile: [
    { key: "simsales",  label: "SIM Sales",       labelAr: "مبيعات الشريحة",   value: "3,412", delta: "+8%",  deltaUp: true,  icon: "ri-sim-card-line",        color: "#D4A84B", action: "Submit SIM Sale",  actionAr: "إرسال بيع شريحة" },
  ...
  municipality: [
    { key: "leases",    label: "New Leases",      labelAr: "عقود جديدة",       value: "312",   delta: "+9%",  deltaUp: true,  icon: "ri-home-line",            color: "#D4A84B", action: "Submit Lease",     actionAr: "إرسال عقد" },
  ...
  payment: [
    ...
    { key: "wire",      label: "Wire Transfers",  labelAr: "التحويلات البنكية", value: "1,203", delta: "+4%",  deltaUp: true,  icon: "ri-send-plane-line",      color: "#D4A84B", action: "Submit Transfer",  actionAr: "إرسال تحويل" },
  ...
  borders: [
    ...
    { key: "visas",     label: "Visas Issued",    labelAr: "تأشيرات صادرة",    value: "1,234", delta: "+9%",  deltaUp: true,  icon: "ri-passport-line",        color: "#D4A84B", action: "Submit Visa",      actionAr: "إرسال تأشيرة" },
  ...
  health: [
    ...
    { key: "discharges",label: "Discharges",      labelAr: "الخروج من المستشفى",value:"891",   delta: "+3%",  deltaUp: true,  icon: "ri-door-open-line",       color: "#D4A84B", action: "Submit Discharge", actionAr: "إرسال خروج" },
  ],
  utility: [
    ...
    { key: "modifications",label:"Modifications", labelAr: "التعديلات",         value: "234",   delta: "+3%",  deltaUp: true,  icon: "ri-settings-line",        color: "#D4A84B", action: "Submit Modification",actionAr:"إرسال تعديل" },
  ...
  transport: [
    ...
    { key: "taxi",      label: "Taxi Bookings",   labelAr: "حجوزات تاكسي",     value: "8,234", delta: "+14%", deltaUp: true,  icon: "ri-taxi-line",            color: "#D4A84B", action: "Submit Taxi",      actionAr: "إرسال تاكسي" },
  ...
  education: [
    ...
    { key: "visaext",   label: "Visa Extensions", labelAr: "تمديدات التأشيرة", value: "891",   delta: "+7%",  deltaUp: true,  icon: "ri-passport-line",        color: "#D4A84B", action: "Submit Extension", actionAr: "إرسال تمديد" },
  ...
  employment: [
    ...
    { key: "empchange", label: "Employer Changes",labelAr: "تغييرات صاحب العمل",value:"1,203", delta: "+5%",  deltaUp: true,  icon: "ri-exchange-line",        color: "#D4A84B", action: "Submit Change",    actionAr: "إرسال تغيير" },
  ...
  ecommerce: [
    ...
    { key: "merchants", label: "New Merchants",   labelAr: "تجار جدد",         value: "47",    delta: "+9%",  deltaUp: true,  icon: "ri-store-line",           color: "#D4A84B", action: "Submit Merchant",  actionAr: "إرسال تاجر" },
  ],
  social: [
...
export const eventFeedByType: Record<EntityType, EventFeedItem[]> = {
  hotel: [
    ...
    { id: "e2", type: "Booking Created",typeAr: "إنشاء حجز",     color: "#D4A84B", ref: "HTL-2025-04890", detail: "Reservation for Sarah Johnson — 3 nights, Suite 512",  detailAr: "حجز لسارة جونسون — 3 ليالٍ، جناح 512",          time: "8 min ago",  status: "accepted" },
  ...
  "car-rental": [
    ...
    { id: "e2", type: "Rental Booking", typeAr: "حجز تأجير",     color: "#D4A84B", ref: "CAR-2025-07233", detail: "Nissan Patrol (OM-67890) — 7 days, Muscat Airport",    detailAr: "نيسان باترول (OM-67890) — 7 أيام، مطار مسقط",   time: "11 min ago", status: "accepted" },
  ...
  mobile: [
    ...
    { id: "e4", type: "Roaming Active", typeAr: "تفعيل تجوال",   color: "#D4A84B", ref: "MOB-2025-19231", detail: "International roaming enabled — UAE, KSA, UK",         detailAr: "تفعيل التجوال الدولي — الإمارات، السعودية، UK",  time: "29 min ago", status: "accepted" },
  ...
  municipality: [
    ...
    { id: "e2", type: "Lease Renewal",  typeAr: "تجديد إيجار",   color: "#D4A84B", ref: "MUN-2025-03420", detail: "Renewal — Apt 4B, Ruwi, Tenant: Al-Farsi Family",     detailAr: "تجديد — شقة 4B، الروي، مستأجر: عائلة الفارسي",  time: "18 min ago", status: "accepted" },
  ...
  payment: [
    ...
    { id: "e3", type: "Currency Exchange",typeAr:"صرف عملات",     color: "#D4A84B", ref: "PAY-2025-88232", detail: "USD 50,000 → OMR — Exchange rate 0.385",              detailAr: "50,000 دولار → ريال — سعر الصرف 0.385",          time: "21 min ago", status: "accepted" },
  ...
  borders: [
    ...
    { id: "e3", type: "Visa Issued",    typeAr: "إصدار تأشيرة",  color: "#D4A84B", ref: "BRD-2025-44889", detail: "Tourist visa — 30 days, Passport: IN-4523891",        detailAr: "تأشيرة سياحية — 30 يوماً، جواز: IN-4523891",     time: "12 min ago", status: "accepted" },
  ...
  health: [
    ...
    { id: "e4", type: "Patient Discharge",  typeAr:"خروج مريض",  color: "#D4A84B", ref: "HLT-2025-22338", detail: "Discharged after 4 days — Ward 3B, Bed 12",           detailAr: "خروج بعد 4 أيام — جناح 3B، سرير 12",             time: "39 min ago", status: "accepted" },
  ...
  utility: [
    ...
    { id: "e2", type: "Service Modified",   typeAr: "تعديل خدمة", color: "#D4A84B", ref: "UTL-2025-11233", detail: "Tariff upgrade — Account #AC-77234, Commercial",      detailAr: "ترقية التعريفة — حساب #AC-77234، تجاري",          time: "19 min ago", status: "accepted" },
  ...
  transport: [
    ...
    { id: "e2", type: "Taxi Booking",   typeAr: "حجز تاكسي",     color: "#D4A84B", ref: "TRN-2025-55233", detail: "Taxi #TX-8823 — Airport to Qurum, 18.4 km",          detailAr: "تاكسي #TX-8823 — المطار إلى القرم، 18.4 كم",     time: "8 min ago",  status: "accepted" },
  ...
  education: [
    ...
    { id: "e2", type: "Visa Extension", typeAr: "تمديد تأشيرة",  color: "#D4A84B", ref: "EDU-2025-08233", detail: "Student visa extended 1 year — Passport: IN-7823401", detailAr: "تمديد تأشيرة طالب سنة — جواز: IN-7823401",        time: "17 min ago", status: "accepted" },
  ...
  employment: [
    ...
    { id: "e2", type: "Employer Change", typeAr: "تغيير صاحب عمل",color:"#D4A84B", ref: "EMP-2025-33233", detail: "Transfer — Al-Rashidi Group → Oman Oil Company",      detailAr: "نقل — مجموعة الراشدي → شركة النفط العُمانية",     time: "16 min ago", status: "accepted" },
  ...
  ecommerce: [
    ...
    { id: "e4", type: "Merchant Registration",typeAr:"تسجيل تاجر",color:"#D4A84B", ref: "ECM-2025-77231", detail: "New merchant — Al-Amri Dates LLC, Category: Food",    detailAr: "تاجر جديد — شركة العامري للتمور، فئة: غذاء",      time: "37 min ago", status: "accepted" },
