...
export const iocEntries: IocEntry[] = [
  ...
  },
  {
    ...
    tags: ["spear-phishing", "impersonation", "police"],
    description: "Email address impersonating National Police. Used in targeted phishing campaign against border officials.",
    tlp: "AMBER",
  },
  {
    id: "ioc-006",
...
export const darkWebMentions: DarkWebMention[] = [
  ...
  },
  {
    ...
    content: "Police network credentials for sale. VPN access to internal systems. Verified working. Price negotiable.",
    author: "insider_leak_2025",
    timestamp: "2025-04-03 22:08",
    severity: "critical",
    category: "terrorism",
    keywords: ["Police", "credentials", "VPN", "internal"],
