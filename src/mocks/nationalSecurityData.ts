...
export const threatLevelConfig: Record<ThreatLevel, { color: string; bg: string; border: string; label: string; labelAr: string; description: string; descriptionAr: string }> = {
  CRITICAL: { color: "#C94A5E", bg: "rgba(201,74,94,0.12)", border: "rgba(201,74,94,0.4)", label: "CRITICAL",  labelAr: "حرج",     description: "Imminent threat — maximum security posture", descriptionAr: "تهديد وشيك — أقصى درجات الأمن" },
  HIGH:     { color: "#C98A1B", bg: "rgba(201,138,27,0.12)",  border: "rgba(201,138,27,0.4)",  label: "HIGH",      labelAr: "عالٍ",    description: "Significant threat — heightened vigilance",  descriptionAr: "تهديد كبير — يقظة مشددة" },
  ...
  GUARDED:  { color: "#D6B47E", bg: "rgba(184,138,60,0.12)",  border: "rgba(184,138,60,0.4)",  label: "GUARDED",   labelAr: "محدود",   description: "General risk — standard protocols active",   descriptionAr: "خطر عام — بروتوكولات قياسية" },
...
export const threatIndicators: ThreatIndicator[] = [
  ...
  { id: "ti6",  stream: "Transport",   streamIcon: "ri-bus-line",              streamColor: "#C98A1B", signal: "Repeated route anomaly near restricted zone — Route 7",           severity: "medium",   score: 62, time: "13:30", location: "Industrial Zone" },
...
export const activeInvestigations: Investigation[] = [
  {
    ...
    category: "Counter-Terrorism",  categoryColor: "#C94A5E",
  ...
  },
  {
    ...
    category: "Narcotics",          categoryColor: "#C98A1B",
...
export const watchlistHits: WatchlistHit[] = [
  { id: "wh1",  time: "14:32:07", personRef: "***4521", nationality: "IR", listType: "Terrorism Watch",    listColor: "#C94A5E", stream: "Border",     streamIcon: "ri-passport-line",     location: "Muscat Airport T1",  matchConfidence: 97, status: "confirmed",     action: "Detained for questioning" },
  ...
  { id: "wh4",  time: "13:22:05", personRef: "***3312", nationality: "OM", listType: "Narcotics Watch",    listColor: "#C98A1B", stream: "Customs",    streamIcon: "ri-ship-line",         location: "Seeb Port",          matchConfidence: 84, status: "pending",       action: "Cargo held for inspection" },
  ...
  { id: "wh6",  time: "12:30:18", personRef: "***5523", nationality: "OM", listType: "Terrorism Watch",    listColor: "#C94A5E", stream: "Mobile",     streamIcon: "ri-sim-card-line",     location: "Ruwi Area",          matchConfidence: 71, status: "pending",       action: "Location tracking active" },
  ...
  { id: "wh8",  time: "11:30:44", personRef: "***2234", nationality: "AF", listType: "Terrorism Watch",    listColor: "#C94A5E", stream: "Border",     streamIcon: "ri-passport-line",     location: "Muscat Airport T2",  matchConfidence: 95, status: "confirmed",     action: "Detained — case INV-2026-0041" },
];
...
export const correlationAlerts: CorrelationAlert[] = [
  ...
  },
  {
    ...
    streams: [
      ...
      { name: "Transport", icon: "ri-bus-line",   color: "#C98A1B" },
    ],
  ...
  },
  {
    ...
    streams: [
      ...
      { name: "Hotel",      icon: "ri-hotel-line",     color: "#D6B47E" },
    ],
  ...
  },
  {
    ...
    streams: [
      { name: "Healthcare", icon: "ri-heart-pulse-line", color: "#C94A5E" },
      { name: "Financial",  icon: "ri-bank-card-line",   color: "#4ADE80" },
    ],
...
export const streamThreatScores: { stream: string; icon: string; color: string; score: number; trend: "up" | "down" | "stable"; events: number; alerts: number }[] = [
  ...
  { stream: "Transport",            icon: "ri-bus-line",             color: "#C98A1B", score: 45, trend: "down",   events: 42891, alerts: 1 },
  { stream: "Employment Registry",  icon: "ri-briefcase-line",       color: "#F9A8D4", score: 42, trend: "stable", events: 3891,  alerts: 1 },
  { stream: "Hotel Intelligence",   icon: "ri-hotel-line",           color: "#D6B47E", score: 38, trend: "down",   events: 1284,  alerts: 1 },
  { stream: "Healthcare",           icon: "ri-heart-pulse-line",     color: "#C94A5E", score: 35, trend: "stable", events: 1847,  alerts: 1 },
