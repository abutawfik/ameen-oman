...
export const DEMO_NARRATIONS: NarrationScript[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────
  // Wave 5 · Public landing + operator portal walkthroughs
  // ───────────────────────────────────────────────────────────────────────
  {
    route: "/",
    title: "Al-Ameen public landing",
    titleAr: "الواجهة العامة للأمين",
    steps: [
      {
        targetSelector: "[data-narrate-id='home-hero-eyebrow']",
        titleEn: "Operated by National Police HQ",
        titleAr: "تحت إشراف قيادة الشرطة الوطنية",
        bodyEn: "This establishes legitimacy — Al-Ameen operates under National Police HQ, not as third-party SaaS. Classification-adjacent from day one.",
        bodyAr: "يرسّخ الشرعية — الأمين منظومة تابعة لقيادة الشرطة الوطنية، ليست خدمة خارجية. مجاور للتصنيف منذ اليوم الأول.",
      },
      {
        targetSelector: "[data-narrate-id='home-hero-tagline']",
        titleEn: "Bilingual by principle",
        titleAr: "ثنائية اللغة بالمبدأ",
        bodyEn: "Brand principle: Arabic and English are peers, never translations. The Arabic slogan الحارس الأمين للوطن is always visible.",
        bodyAr: "مبدأ العلامة: العربية والإنجليزية نظيرتان، لا ترجمة. شعار «الحارس الأمين للوطن» حاضر دائماً.",
      },
      {
        targetSelector: "[data-narrate-id='home-intelligence-tabs']",
        titleEn: "16 intelligence streams",
        titleAr: "16 تيار استخبارات",
        bodyEn: "Al-Ameen fuses 16 real-time streams. Four core — Hotel · Car Rental · Mobile Ops · Municipality. Twelve extended. Click any tab to see classification and refresh.",
        bodyAr: "يدمج الأمين 16 تياراً لحظياً. أربعة أساسية — الفندق والإيجار والاتصالات والبلدية. اثنا عشر ممتداً. اضغط أي تبويب لعرض التصنيف والتحديث.",
      },
      {
        targetSelector: "[data-narrate-id='home-data-flow']",
        titleEn: "Ingest → Normalise → Score → Deliver",
        titleAr: "استيعاب ← تطبيع ← تقييم ← تسليم",
        bodyEn: "Every signal carries provenance and classification. Scoring is deterministic — identical inputs produce the same score within 0.01.",
        bodyAr: "كل إشارة تحمل مصدرها وتصنيفها. التقييم حتمي — نفس المدخلات تعطي الدرجة نفسها بفارق 0.01.",
      },
    ],
  },
  {
    ...
    titleAr: "تسجيل الدخول للمشغّل",
    steps: [
      {
        targetSelector: "[data-narrate-id='login-ceremonial-pane']",
        titleEn: "Gov-operator portal",
        titleAr: "بوابة المشغّل الحكومي",
        bodyEn: "Gov-operator portal. Access is logged and audited. Authorised-personnel-only surface.",
        bodyAr: "بوابة مشغّل حكومية. كل وصول مسجَّل ومدقَّق. سطح للمخوّلين فقط.",
      },
      {
        targetSelector: "[data-narrate-id='login-sso-button']",
        titleEn: "SSO primary · Officer-ID fallback",
        titleAr: "الدخول الموحَّد أولاً · معرّف الضابط بديلاً",
        bodyEn: "Primary path: Government Identity Provider SSO. Fallback: Officer ID + Passcode → OTP 2FA.",
        bodyAr: "المسار الأساسي: الدخول الموحَّد الحكومي. البديل: معرّف الضابط ورمز المرور ثم رمز التحقق.",
      },
      {
        targetSelector: "[data-narrate-id='login-legal-footer']",
        titleEn: "Session recording + lineage",
        titleAr: "تسجيل الجلسات وسلسلة القرارات",
        bodyEn: "Every session is recorded. Every adjudication carries full lineage logged for audit.",
        bodyAr: "كل جلسة تُسجَّل. كل حكم يحمل سلسلته كاملة في سجل التدقيق.",
      },
    ],
  },
  {
    ...
    titleAr: "قوائم المراقبة والأهداف",
    steps: [
      {
        targetSelector: "[data-narrate-id='watchlist-header-kpis']",
        titleEn: "Deterministic match layer",
        titleAr: "طبقة المطابقة الحتمية",
        bodyEn: "Watchlist is the deterministic match layer. Exact-ID matches auto-flag. Fuzzy matches at ≥0.92 auto-flag too.",
        bodyAr: "قائمة المراقبة هي طبقة المطابقة الحتمية. التطابق بالمعرّف تلقائي. التطابق التقريبي ≥0.92 تلقائي أيضاً.",
      },
      {
        targetSelector: "[data-narrate-id='watchlist-target-list']",
        titleEn: "Target window + severity",
        titleAr: "نافذة الهدف والخطورة",
        bodyEn: "Each target carries classification, severity, and a valid-from/valid-to window. Hits fire straight to the Operator Queue.",
        bodyAr: "كل هدف له تصنيف وخطورة ونافذة سريان. الإصابات تنتقل مباشرة لقائمة المشغّل.",
      },
      {
        targetSelector: "[data-narrate-id='watchlist-import-export']",
        titleEn: "Interpol + partner ingest",
        titleAr: "استيراد الإنتربول والشركاء",
        bodyEn: "Bulk ingest from Interpol notices and partner agencies — we don't reinvent the watchlist registry.",
        bodyAr: "استيراد جماعي من نشرات الإنتربول والأجهزة الشريكة — لا نعيد اختراع سجل المراقبة.",
      },
      {
        targetSelector: "[data-narrate-id='watchlist-empty-state']",
        titleEn: "One of nine sub-scores",
        titleAr: "إحدى تسع درجات فرعية",
        bodyEn: "Watchlist is one contribution of nine — deterministic precision; the ML layer provides recall.",
        bodyAr: "قائمة المراقبة إحدى تسع مساهمات — دقّة حتمية، بينما طبقة التعلم الآلي تكفل الاسترجاع.",
      },
    ],
  },
  {
    route: "/dashboard/notifications",
    title: "Notifications · routing · channels",
    titleAr: "الإشعارات والتوجيه والقنوات",
    steps: [
      {
        targetSelector: "[data-narrate-id='notifications-inbox-tab']",
        titleEn: "Live alert inbox",
        titleAr: "صندوق التنبيهات المباشر",
        bodyEn: "Live alert feed. Acknowledge inline. Severity-coloured left border.",
        bodyAr: "تدفق تنبيهات مباشر. الإقرار من داخل الصف. حدّ يسار ملوَّن بحسب الخطورة.",
      },
      {
        targetSelector: "[data-narrate-id='notifications-routing-rules']",
        titleEn: "Tech Spec §16 routing",
        titleAr: "قواعد التوجيه §16",
        bodyEn: "CRITICAL → on-duty + lead + SMS, ack 15 min. HIGH → analyst in-app + email, 1 hr. MEDIUM → queue. LOW → digest.",
        bodyAr: "حرج ← المناوب والقائد ورسالة نصية، إقرار 15 د. عالٍ ← المحلل عبر التطبيق والبريد، ساعة. متوسط ← قائمة. منخفض ← نشرة.",
      },
      {
        targetSelector: "[data-narrate-id='notifications-rules-row']",
        titleEn: "Edit recipients + SLA",
        titleAr: "تحرير المستلمين و SLA",
        bodyEn: "Click any severity row to edit recipients, channels, SLA. This is where alert fatigue gets tuned — noise discipline is the product.",
        bodyAr: "اضغط أي صف خطورة لتحرير المستلمين والقنوات و SLA. هنا تُضبط رتابة التنبيه — انضباط الضوضاء هو المنتج.",
      },
      {
        targetSelector: "[data-narrate-id='notifications-channel-config']",
        titleEn: "Five channels · test + health",
        titleAr: "خمس قنوات · اختبار وصحّة",
        bodyEn: "In-app, email, SMS, webhook, voice. Health + last-test + per-channel config. Test button simulates delivery.",
        bodyAr: "داخل التطبيق، بريد، رسالة، ويب هوك، صوت. صحّة القناة وآخر اختبار وإعداد خاص. زرّ الاختبار يحاكي التسليم.",
      },
    ],
  },
  {
    ...
    titleAr: "صانع التقارير",
    steps: [
      {
        targetSelector: "[data-narrate-id='reports-template-grid']",
        titleEn: "Six pre-built reports",
        titleAr: "ستة تقارير جاهزة",
        bodyEn: "Daily Ops, Weekly Source Health, Monthly Executive, Quarterly Governance, Ad-hoc Score Audit, Compliance Summary.",
        bodyAr: "العمليات اليومي، صحّة المصادر الأسبوعي، التنفيذي الشهري، الحوكمة الربعي، تدقيق الدرجة الآني، ملخّص الامتثال.",
      },
      {
        targetSelector: "[data-narrate-id='reports-daily-ops-card']",
        titleEn: "Generate → live preview",
        titleAr: "توليد ← معاينة مباشرة",
        bodyEn: "One click previews the rendered 4-page PDF. Every report is tied to live Al-Ameen data — score audits are fully traceable.",
        bodyAr: "ضغطة واحدة تُعاين ملف PDF من 4 صفحات. كل تقرير مرتبط ببيانات الأمين المباشرة — تدقيقات الدرجة قابلة للتتبّع بالكامل.",
      },
      {
        targetSelector: "[data-narrate-id='reports-custom-tile']",
        titleEn: "Custom template builder",
        titleAr: "بانٍ قوالب مخصَّصة",
        bodyEn: "Need a custom cut? Section picker covers every data surface — KPIs, trends, fairness bars, audit excerpts.",
        bodyAr: "تحتاج تصميماً خاصاً؟ منتقي الأقسام يغطي كل السطوح — مؤشرات واتجاهات وأشرطة عدالة ومقتطفات تدقيق.",
      },
      {
        targetSelector: "[data-narrate-id='reports-scheduled-link']",
        titleEn: "Four active schedules",
        titleAr: "أربع جدولات نشطة",
        bodyEn: "Switch to Scheduled for automated runs — Daily 08:00, Weekly Mon 09:00, Monthly, Quarterly. Recipients + status + run-now + toggle.",
        bodyAr: "انتقل للمجدول لعرض التشغيل الآلي — يومي 08:00، أسبوعي الإثنين 09:00، شهري، ربعي. المستلمون والحالة وتشغيل الآن والتفعيل.",
      },
    ],
  },
  {
    route: "/dashboard/risk-assessment",
    title: "Risk Assessment — Phase 1 + Phase 2",
    titleAr: "تقييم المخاطر — المرحلتان 1 و 2",
    steps: [
      {
        targetSelector: "[data-narrate-id='risk-phase1-tab']",
        titleEn: "Phase 1 binary flag",
        titleAr: "المرحلة 1 · تنبيه ثنائي",
        bodyEn: "Phase 1: simple binary watchlist + rule flag. Historic baseline system — still live, still useful.",
        bodyAr: "المرحلة 1: تنبيه ثنائي من قواعد وقائمة مراقبة. منظومة الأساس التاريخي — لا زالت حيّة ومفيدة.",
      },
      {
        targetSelector: "[data-narrate-id='risk-phase2-tab']",
        titleEn: "Phase 2 weighted score",
        titleAr: "المرحلة 2 · درجة موزونة",
        bodyEn: "Phase 2: 9-sub-score weighted system. Operators can override Phase 1 with context-aware risk from ML + OSINT.",
        bodyAr: "المرحلة 2: منظومة 9 درجات فرعية موزونة. يستطيع المشغّل تجاوز المرحلة 1 بمخاطر واعية للسياق من التعلم الآلي و OSINT.",
      },
      {
        targetSelector: "[data-narrate-id='risk-config-tab']",
        titleEn: "Weight-tunable + auditable",
        titleAr: "أوزان قابلة للضبط والتدقيق",
        bodyEn: "Weight-tunable in real time, auditable, surfaced via the same YAML-reload pattern as the OSINT engine's rules.",
        bodyAr: "قابلة للضبط لحظياً، مدقَّقة، تُستعرض بنفس نمط إعادة تحميل YAML المستخدم في قواعد محرك OSINT.",
      },
    ],
  },
];
