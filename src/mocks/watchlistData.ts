export type WatchlistType = 'national_security' | 'overstay' | 'financial' | 'employment' | 'interpol' | 'sanctions' | 'custom';
...
export const watchlists: Watchlist[] = [
  ...
  {
    id: 'wl-007',
    name: 'Netherlands Sanctions List',
    nameAr: 'قائمة العقوبات الهولندية',
    description: 'EU/UN-designated individuals and entities subject to financial sanctions under Dutch law. Includes ISIL/Al-Qaeda, North Korea proliferation, Russia/Iran asset-freeze programmes.',
    descriptionAr: 'أفراد وكيانات مُدرَجون بموجب قرارات الأمم المتحدة/الاتحاد الأوروبي وخاضعون لعقوبات مالية وفق القانون الهولندي.',
    type: 'sanctions',
    classification: 'SECRET',
    owner: 'Ministry of Finance — NL / OFSI',
    priority: 'critical',
    autoExpireDays: null,
    alertRouting: ['Financial Intelligence Unit', 'Command Center', 'NSA'],
    targetCount: 485,
    hitsToday: 2,
    hitsTotal: 94,
    createdAt: '2026-08-18',
    lastHit: '2026-08-18 06:00',
    active: true,
  },
  {
    id: 'wl-006',
...
export const watchlistTargets: WatchlistTarget[] = [
  ...
  // ── Netherlands Sanctions List (wl-007) ──────────────────────────────────
  {
    id: 'tgt-007',
    watchlistIds: ['wl-007', 'wl-003'],
    name: 'Hassan Khalid Al-Makhsoud',
    nameAr: 'حسن خالد المخصود',
    docNumber: 'SY-8834671',
    docType: 'Passport',
    nationality: 'Syrian',
    dob: '1976-04-12',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20middle%20eastern%20man%20in%20his%2050s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt007&orientation=squarish',
    riskScore: 97,
    riskLevel: 'critical',
    status: 'active',
    addedBy: 'NL Sanctions Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'EU/UN-designated ISIL financial facilitator. Ref: NL-2022-0847 · EU-ISIL-2022-0112. Asset freeze and travel ban in force.',
    notes: 'Known to operate under aliases. Uses hawala networks across Turkey, Jordan, and the Gulf. Subject of Interpol Diffusion notice.',
    lastKnownLocation: 'Unknown — last passport scan Amman, Jordan',
    lastKnownLocationTime: '2025-11-04 14:30',
    lastEvent: 'Passport scan — Queen Alia International Airport',
    lastEventStream: 'Border Intelligence',
    lastEventTime: '2025-11-04 14:30',
    phone: '',
    email: '',
    employer: 'Unknown',
    alertCount: 8,
  },
  {
    id: 'tgt-008',
    watchlistIds: ['wl-007'],
    name: 'Viktor Nikolaev Petrovsky',
    nameAr: 'فيكتور نيكولاييف بيتروفسكي',
    docNumber: 'RU-3928410',
    docType: 'Passport',
    nationality: 'Russian',
    dob: '1968-09-28',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20white%20european%20man%20in%20his%2050s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt008&orientation=squarish',
    riskScore: 85,
    riskLevel: 'high',
    status: 'active',
    addedBy: 'NL Sanctions Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'Designated under EU Council Regulation 269/2014 — asset freeze and travel ban. Ref: NL-2022-1024. Senior executive linked to sanctioned energy sector entities.',
    notes: 'Holds dual Russian/Cypriot passport. Extensive real-estate holdings in UAE and Oman believed to be beneficial ownership.',
    lastKnownLocation: 'Dubai, UAE',
    lastKnownLocationTime: '2026-03-15 10:22',
    lastEvent: 'Entry — Dubai International Airport Terminal 1',
    lastEventStream: 'Border Intelligence',
    lastEventTime: '2026-03-15 10:22',
    phone: '',
    email: 'v.petrovsky@cyprusvault.eu',
    employer: 'Neftegaz Capital Ltd (sanctioned)',
    alertCount: 3,
  },
  {
    id: 'tgt-009',
    watchlistIds: ['wl-007', 'wl-001'],
    name: 'Li Jun-Wei',
    nameAr: 'لي جون ووي',
    docNumber: 'KP-0044512',
    docType: 'Diplomatic Passport',
    nationality: 'North Korean',
    dob: '1971-12-03',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20east%20asian%20man%20in%20his%2050s%2C%20neutral%20expression%2C%20formal%20suit%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt009&orientation=squarish',
    riskScore: 94,
    riskLevel: 'critical',
    status: 'active',
    addedBy: 'NL Sanctions Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'UN Security Council designation for WMD proliferation financing. Ref: NL-DPRK-2021-0034. Suspected front-company procurement for DPRK missile program.',
    notes: 'Travels on diplomatic passport. Reported to use multiple alias identities. UNSCR 1718 Committee listing.',
    lastKnownLocation: 'Beijing, China',
    lastKnownLocationTime: '2026-01-09 08:45',
    lastEvent: 'Transit — Beijing Capital International',
    lastEventStream: 'Border Intelligence',
    lastEventTime: '2026-01-09 08:45',
    phone: '',
    email: '',
    employer: 'Korea Ryongbong General Corp (sanctioned)',
    alertCount: 5,
  },
  {
    id: 'tgt-010',
    watchlistIds: ['wl-007', 'wl-003'],
    name: 'Bashir Mohammad Rahimi',
    nameAr: 'بشير محمد رحيمي',
    docNumber: 'IR-6621809',
    docType: 'Passport',
    nationality: 'Iranian',
    dob: '1974-08-17',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20middle%20eastern%20man%20in%20his%2040s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt010&orientation=squarish',
    riskScore: 88,
    riskLevel: 'high',
    status: 'active',
    addedBy: 'NL Sanctions Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'EU Iran sanctions — oil revenue smuggling and sanctions evasion. Ref: NL-IRAN-2023-0072. Operates front shipping companies to circumvent oil export ban.',
    notes: 'Director of 3 shell companies registered in Oman and UAE. Suspected to route proceeds through regional banks.',
    lastKnownLocation: 'Muscat, Oman — Al Khuwair Commercial District',
    lastKnownLocationTime: '2026-08-17 14:10',
    lastEvent: 'Wire transfer flagged — OMR 320,000 outbound',
    lastEventStream: 'Financial Services',
    lastEventTime: '2026-08-17 14:10',
    phone: '+968 9812 3344',
    email: 'b.rahimi@golftanker.com',
    employer: 'Gulf Tanker Shipping LLC (front company)',
    alertCount: 12,
  },
  {
    id: 'tgt-011',
    watchlistIds: ['wl-007', 'wl-001'],
    name: 'Arjun Mehta Subramaniam',
    nameAr: 'أرجون ميهتا سوبرامانيام',
    docNumber: 'IN-4489234',
    docType: 'Passport',
    nationality: 'Indian',
    dob: '1980-02-26',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20south%20asian%20man%20in%20his%2040s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt011&orientation=squarish',
    riskScore: 91,
    riskLevel: 'critical',
    status: 'active',
    addedBy: 'NL Sanctions Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'EU-designated ISIL financial network facilitator — hawala operations linking Gulf states to conflict zones. Ref: NL-2023-0591.',
    notes: 'Operates informal money transfer (hawala) network across India, UAE, and Oman. Frequently moves between Hyderabad, Dubai, and Muscat.',
    lastKnownLocation: 'Ruwi, Muscat',
    lastKnownLocationTime: '2026-08-16 11:50',
    lastEvent: 'Hotel Check-In — Al Bustan Palace Hotel',
    lastEventStream: 'Hotel Intelligence',
    lastEventTime: '2026-08-16 11:50',
    phone: '+968 9456 7821',
    email: 'arjun.mehta.business@gmail.com',
    employer: 'Global Remit Services (suspected hawala front)',
    alertCount: 19,
  },

  // ── Interpol Red Notices (wl-005) ────────────────────────────────────────
  {
    id: 'tgt-012',
    watchlistIds: ['wl-005', 'wl-001'],
    name: 'Dmitri Alexandr Volkov',
    nameAr: 'دميتري ألكسندر فولكوف',
    docNumber: 'RU-4452018',
    docType: 'Passport',
    nationality: 'Russian',
    dob: '1973-02-28',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20white%20european%20man%20in%20his%2050s%2C%20stern%20expression%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt012&orientation=squarish',
    riskScore: 93,
    riskLevel: 'critical',
    status: 'active',
    addedBy: 'Interpol Red Notices Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'INTERPOL Red Notice A-1234/2022. Wanted by Russian Federation for murder, organised crime leadership, drug trafficking. Escaped custody 2021.',
    notes: 'Considered armed and dangerous. Known to travel on forged EU documents. Believed to be hiding assets in Gulf region.',
    lastKnownLocation: 'Unknown — suspected UAE or Oman',
    lastKnownLocationTime: '2025-12-20 00:00',
    lastEvent: 'Unconfirmed sighting — Dubai property registry',
    lastEventStream: 'OSINT',
    lastEventTime: '2025-12-20 00:00',
    phone: '',
    email: '',
    employer: 'Unknown',
    alertCount: 6,
  },
  {
    id: 'tgt-013',
    watchlistIds: ['wl-005'],
    name: 'Maria Elena Santos Ferreira',
    nameAr: 'ماريا إيلينا سانتوس فيريرا',
    docNumber: 'BR-8821930',
    docType: 'Passport',
    nationality: 'Brazilian',
    dob: '1985-07-14',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20latin%20american%20woman%20in%20her%2030s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt013&orientation=squarish',
    riskScore: 79,
    riskLevel: 'high',
    status: 'active',
    addedBy: 'Interpol Red Notices Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'INTERPOL Red Notice A-7823/2021. Wanted by Brazil — money laundering (BRL 240M), drug trafficking, corruption. Associated with Primeiro Comando do Cartel network.',
    notes: 'Highly mobile. Previously detained in Portugal, released on bail, absconded. Fluent in Portuguese, Spanish, and English.',
    lastKnownLocation: 'Unknown — last seen Lisbon, Portugal 2023',
    lastKnownLocationTime: '2023-06-11 00:00',
    lastEvent: 'Passport scan — Lisbon Portela Airport',
    lastEventStream: 'Border Intelligence',
    lastEventTime: '2023-06-11 18:40',
    phone: '',
    email: '',
    employer: 'Unknown',
    alertCount: 2,
  },
  {
    id: 'tgt-014',
    watchlistIds: ['wl-005', 'wl-001'],
    name: 'Ahmed Yusuf Ibrahim',
    nameAr: 'أحمد يوسف إبراهيم',
    docNumber: 'SO-0034521',
    docType: 'Travel Document',
    nationality: 'Somali',
    dob: '1988-03-21',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20east%20african%20man%20in%20his%2030s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt014&orientation=squarish',
    riskScore: 96,
    riskLevel: 'critical',
    status: 'active',
    addedBy: 'Interpol Red Notices Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'INTERPOL Red Notice A-0045/2020. Wanted by Kenya for terrorism and murder — linked to the 2019 Nairobi Dusit Hotel attack (DusitD2 complex). Believed to have crossed into Gulf region.',
    notes: 'SUBJECT IS ARMED AND DANGEROUS. Do not approach without armed support. Contact Interpol NCB Nairobi immediately on any match.',
    lastKnownLocation: 'Unknown — believed Gulf region',
    lastKnownLocationTime: '2026-04-02 00:00',
    lastEvent: 'Possible match — Dubai Airport facial recognition (unconfirmed)',
    lastEventStream: 'OSINT',
    lastEventTime: '2026-04-02 00:00',
    phone: '',
    email: '',
    employer: 'Unknown — Al-Shabaab affiliation suspected',
    alertCount: 14,
  },
  {
    id: 'tgt-015',
    watchlistIds: ['wl-005'],
    name: 'Jean-Pierre Leclerc Moreau',
    nameAr: 'جان-بيير ليكليرك مورو',
    docNumber: 'FR-6614290',
    docType: 'Passport',
    nationality: 'French',
    dob: '1966-11-19',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20european%20man%20in%20his%2060s%2C%20neutral%20expression%2C%20formal%20suit%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt015&orientation=squarish',
    riskScore: 74,
    riskLevel: 'high',
    status: 'active',
    addedBy: 'Interpol Red Notices Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'INTERPOL Red Notice A-3312/2023. Wanted by France — large-scale investment fraud (€180M), embezzlement, forgery of financial documents. Fled to Gulf region after Paris conviction in absentia.',
    notes: 'Former investment banker. Uses sophisticated document forgery. Known to present as legitimate businessman in real estate.',
    lastKnownLocation: 'Muscat, Oman — seen at Al Mouj Marina',
    lastKnownLocationTime: '2026-07-29 17:00',
    lastEvent: 'Hotel Check-In — Shangri-La Al Husn Muscat (alias "Pierre Lavigne")',
    lastEventStream: 'Hotel Intelligence',
    lastEventTime: '2026-07-29 17:00',
    phone: '+968 9700 1245',
    email: 'pierre.lavigne.invest@gmail.com',
    employer: 'Lavigne Capital Partners (alias identity)',
    alertCount: 9,
  },
  {
    id: 'tgt-016',
    watchlistIds: ['wl-005', 'wl-001'],
    name: 'Yusuf Emeka Okonkwo',
    nameAr: 'يوسف إيميكا أوكونكوو',
    docNumber: 'NG-2233401',
    docType: 'Passport',
    nationality: 'Nigerian',
    dob: '1975-08-09',
    photo: 'https://readdy.ai/api/search-image?query=professional%20headshot%20of%20west%20african%20man%20in%20his%2050s%2C%20neutral%20expression%2C%20formal%20attire%2C%20clean%20white%20background%2C%20high%20quality%20portrait%20photography&width=80&height=80&seq=tgt016&orientation=squarish',
    riskScore: 89,
    riskLevel: 'high',
    status: 'active',
    addedBy: 'Interpol Red Notices Import — 2026-08-18',
    addedAt: '2026-08-18',
    reason: 'INTERPOL Red Notice A-5589/2022. Wanted by Nigeria and Interpol for arms trafficking, human trafficking, and MANPADS smuggling from Libyan conflict zone.',
    notes: 'Operates multiple front businesses in logistics and cargo. Believed to transit through Gulf ports for arms shipment. High-value target.',
    lastKnownLocation: 'Unknown — last confirmed Mombasa, Kenya',
    lastKnownLocationTime: '2026-02-14 00:00',
    lastEvent: 'Cargo manifest — suspect consignment via Salalah port (unconfirmed)',
    lastEventStream: 'Border Intelligence',
    lastEventTime: '2026-02-14 00:00',
    phone: '',
    email: '',
    employer: 'Eagle Freight Solutions Nigeria (suspected arms front)',
    alertCount: 7,
  },
];
...
export const hitFrequencyData = [
  ...
  { list: 'Netherlands Sanctions', hits: [0, 1, 0, 2, 1, 0, 2] },
];
