...
export const mockStreamSummary: StreamSummary[] = [
  ...
  { stream: "hotel",        icon: "ri-hotel-line",           color: "#D6B47E", label: "3 stays",           count: 3,  active: true,  lastEvent: "2026-04-01" },
  { stream: "mobile",       icon: "ri-sim-card-line",        color: "#A78BFA", label: "2 SIM lines",       count: 2,  active: true,  lastEvent: "2026-03-16" },
  { stream: "car-rental",   icon: "ri-car-line",             color: "#C98A1B", label: "1 rental",          count: 1,  active: true,  lastEvent: "2026-03-20" },
  ...
  { stream: "social",       icon: "ri-global-line",          color: "#C94A5E", label: "3 profiles",        count: 3,  active: true,  lastEvent: "2026-04-05" },
  { stream: "marine",       icon: "ri-ship-line",            color: "#DDB96B", label: "1 boat rental",     count: 1,  active: true,  lastEvent: "2026-03-28" },
  ...
  { stream: "health",       icon: "ri-heart-pulse-line",     color: "#C94A5E", label: "No activity",       count: 0,  active: false, lastEvent: "" },
...
export const mockTravelStops: TravelStop[] = [
  ...
  { seq: 2, location: "Grand Hyatt Capital, Coastal District",datetime: "2026-03-15 11:30", event: "Hotel Check-In",   stream: "Hotel",      streamColor: "#D6B47E", duration: "3 days",  distance: "12 km" },
  { seq: 3, location: "Capital Hills Resort",                 datetime: "2026-03-18 14:30", event: "Hotel Switch",     stream: "Hotel",      streamColor: "#D6B47E", duration: "2 days",  distance: "8 km" },
  { seq: 4, location: "Capital Airport Branch",               datetime: "2026-03-20 08:45", event: "Vehicle Pickup",   stream: "Car Rental", streamColor: "#C98A1B", duration: "7 days",  distance: "15 km" },
  ...
  { seq: 6, location: "Al Mouj Marina, Capital City",         datetime: "2026-03-28 09:00", event: "Boat Rental",      stream: "Marine",     streamColor: "#DDB96B", duration: "6 hrs",   distance: "18 km" },
  ...
  { seq: 8, location: "Al Falaj Hotel, City Center",          datetime: "2026-04-01 15:00", event: "Hotel Check-In",   stream: "Hotel",      streamColor: "#D6B47E", duration: "4 days",  distance: "2 km" },
