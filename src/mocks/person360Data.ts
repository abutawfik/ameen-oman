...
export const mockStreamSummary: StreamSummary[] = [
  ...
  { stream: "hotel",        icon: "ri-hotel-line",           color: "#D4A84B", label: "3 stays",           count: 3,  active: true,  lastEvent: "2026-04-01" },
...
export const mockTravelStops: TravelStop[] = [
  ...
  { seq: 2, location: "Grand Hyatt Capital, Coastal District",datetime: "2026-03-15 11:30", event: "Hotel Check-In",   stream: "Hotel",      streamColor: "#D4A84B", duration: "3 days",  distance: "12 km" },
  { seq: 3, location: "Capital Hills Resort",                 datetime: "2026-03-18 14:30", event: "Hotel Switch",     stream: "Hotel",      streamColor: "#D4A84B", duration: "2 days",  distance: "8 km" },
  ...
  { seq: 8, location: "Al Falaj Hotel, City Center",          datetime: "2026-04-01 15:00", event: "Hotel Check-In",   stream: "Hotel",      streamColor: "#D4A84B", duration: "4 days",  distance: "2 km" },
