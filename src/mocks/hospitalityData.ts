...
export const recentActivities = [
  ...
  { id: 'A002', type: 'booking',     icon: 'ri-calendar-check-line',color: '#D6B47E', guestName: 'Sarah Johnson',        room: '103', time: '14:18', flag: '🇬🇧' },
  { id: 'A003', type: 'check-out',   icon: 'ri-logout-box-line',    color: '#C98A1B', guestName: 'Aisha Al-Harthi',      room: '201', time: '13:55', flag: '🇴🇲' },
  ...
  { id: 'A006', type: 'booking',     icon: 'ri-calendar-check-line',color: '#D6B47E', guestName: 'Chen Wei',             room: '204', time: '11:55', flag: '🇨🇳' },
  { id: 'A007', type: 'check-in',    icon: 'ri-login-box-line',     color: '#4ADE80', guestName: 'James Whitfield',      room: '305', time: '11:20', flag: '🇺🇸' },
  { id: 'A008', type: 'check-out',   icon: 'ri-logout-box-line',    color: '#C98A1B', guestName: 'Khalid Al-Amri',       room: '303', time: '10:45', flag: '🇴🇲' },
];
