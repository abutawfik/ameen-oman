...
export const mockFieldPerson: FieldPerson = {
  ...
  recentEvents: [
    ...
    { stream: "Hotel",     streamIcon: "ri-hotel-line",         streamColor: "#22D3EE", datetime: "2025-03-15 11:30", description: "Check-In — Grand Hyatt Capital",            location: "Coastal District",   isAlert: false },
    ...
    { stream: "Hotel",     streamIcon: "ri-hotel-line",         streamColor: "#22D3EE", datetime: "2025-03-18 14:30", description: "Same-Day Hotel Switch — Capital Hills",     location: "Capital Hills",      isAlert: true  },
  ],
};
