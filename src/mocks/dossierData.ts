...
export const classificationConfig: Record<ClassificationLevel, { color: string; bg: string; border: string; icon: string; description: string }> = {
  ...
  "SECRET":       { color: "#FB923C", bg: "rgba(251,146,60,0.1)",  border: "rgba(251,146,60,0.3)",  icon: "ri-shield-star-line", description: "Highly sensitive — senior officers only" },
  "TOP SECRET":   { color: "#F87171", bg: "rgba(248,113,113,0.1)", border: "rgba(248,113,113,0.3)", icon: "ri-shield-keyhole-line", description: "Maximum classification — director level" },
};
...
export const dossierSections: DossierSection[] = [
  ...
  { key: "identity_documents",    label: "Identity & Documents",               stream: "Identity",    streamIcon: "ri-id-card-line",          streamColor: "#22D3EE", description: "Passport, national ID, visa details, biographic data, aliases", dataPoints: 12, required: true,  classificationMin: "RESTRICTED",   estimatedPages: 2 },
  { key: "biometric_data",        label: "Biometric Records",                  stream: "Identity",    streamIcon: "ri-fingerprint-line",      streamColor: "#22D3EE", description: "Fingerprint records, facial recognition matches, biometric flags", dataPoints: 4,  required: false, classificationMin: "SECRET",       estimatedPages: 1 },
  { key: "risk_assessment",       label: "Risk Assessment & Score",            stream: "Risk",        streamIcon: "ri-shield-cross-line",     streamColor: "#F87171", description: "Composite risk score, contributing factors, risk trend over time", dataPoints: 8,  required: true,  classificationMin: "CONFIDENTIAL", estimatedPages: 3 },
  { key: "pattern_alerts",        label: "Pattern Alerts & Anomalies",         stream: "Risk",        streamIcon: "ri-alert-line",            streamColor: "#F87171", description: "All detected behavioral patterns, anomalies, and cross-stream correlations", dataPoints: 5,  required: true,  classificationMin: "CONFIDENTIAL", estimatedPages: 3 },
  { key: "watchlist_status",      label: "Watchlist & Sanctions Status",       stream: "Watchlist",   streamIcon: "ri-eye-line",              streamColor: "#FB923C", description: "Watchlist membership, sanctions screening, Interpol notices", dataPoints: 3,  required: false, classificationMin: "SECRET",       estimatedPages: 1 },
  ...
  { key: "hotel_stays",           label: "Hotel & Accommodation Records",      stream: "Hotel",       streamIcon: "ri-hotel-line",            streamColor: "#22D3EE", description: "All hotel check-ins/outs, room details, co-guests, payment methods", dataPoints: 3,  required: false, classificationMin: "RESTRICTED",   estimatedPages: 2 },
  { key: "car_rentals",           label: "Car Rental & Vehicle Activity",      stream: "Car Rental",  streamIcon: "ri-car-line",              streamColor: "#FB923C", description: "Vehicle rentals, pickup/dropoff locations, mileage, co-drivers", dataPoints: 1,  required: false, classificationMin: "RESTRICTED",   estimatedPages: 1 },
  ...
  { key: "healthcare_records",    label: "Healthcare & Medical Records",       stream: "Healthcare",  streamIcon: "ri-heart-pulse-line",      streamColor: "#F87171", description: "Hospital visits, prescriptions, emergency admissions, diagnoses", dataPoints: 0,  required: false, classificationMin: "SECRET",       estimatedPages: 2 },
  ...
  { key: "social_intelligence",   label: "Social Media Intelligence",          stream: "Social",      streamIcon: "ri-global-line",           streamColor: "#F87171", description: "Social profiles, flagged posts, keyword matches, network analysis", dataPoints: 3,  required: false, classificationMin: "CONFIDENTIAL", estimatedPages: 3 },
  { key: "marine_activity",       label: "Marine & Maritime Activity",         stream: "Marine",      streamIcon: "ri-anchor-line",           streamColor: "#67E8F9", description: "Boat rentals, marina docking, diving registrations, vessel movements", dataPoints: 1,  required: false, classificationMin: "CONFIDENTIAL", estimatedPages: 1 },
  ...
  { key: "connections_network",   label: "Connections & Network Analysis",     stream: "Analysis",    streamIcon: "ri-share-line",            streamColor: "#22D3EE", description: "Known associates, co-guests, shared devices, network visualization", dataPoints: 7,  required: false, classificationMin: "SECRET",       estimatedPages: 4 },
