...
export const dossierSections: DossierSection[] = [
  ...
  { key: "identity_documents",    label: "Identity & Documents",               stream: "Identity",    streamIcon: "ri-id-card-line",          streamColor: "#D4A84B", description: "Passport, national ID, visa details, biographic data, aliases", dataPoints: 12, required: true,  classificationMin: "RESTRICTED",   estimatedPages: 2 },
  { key: "biometric_data",        label: "Biometric Records",                  stream: "Identity",    streamIcon: "ri-fingerprint-line",      streamColor: "#D4A84B", description: "Fingerprint records, facial recognition matches, biometric flags", dataPoints: 4,  required: false, classificationMin: "SECRET",       estimatedPages: 1 },
  ...
  { key: "hotel_stays",           label: "Hotel & Accommodation Records",      stream: "Hotel",       streamIcon: "ri-hotel-line",            streamColor: "#D4A84B", description: "All hotel check-ins/outs, room details, co-guests, payment methods", dataPoints: 3,  required: false, classificationMin: "RESTRICTED",   estimatedPages: 2 },
  ...
  { key: "connections_network",   label: "Connections & Network Analysis",     stream: "Analysis",    streamIcon: "ri-share-line",            streamColor: "#D4A84B", description: "Known associates, co-guests, shared devices, network visualization", dataPoints: 7,  required: false, classificationMin: "SECRET",       estimatedPages: 4 },
