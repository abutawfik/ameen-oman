...
export const STREAM_WEIGHTS: StreamWeight[] = [
  { key: "hotel",        label: "Hotels",           labelAr: "الفنادق",              icon: "ri-hotel-line",           color: "#D6B47E", weight: 3,  defaultWeight: 3  },
  ...
  { key: "financial",    label: "Financial",         labelAr: "المالية",              icon: "ri-bank-card-line",       color: "#C94A5E", weight: 8,  defaultWeight: 8  },
  { key: "healthcare",   label: "Healthcare",        labelAr: "الرعاية الصحية",       icon: "ri-heart-pulse-line",     color: "#C98A1B", weight: 2,  defaultWeight: 2  },
  ...
  { key: "transport",    label: "Transport",         labelAr: "النقل",                icon: "ri-bus-line",             color: "#C98A1B", weight: 3,  defaultWeight: 3  },
...
export const FLAGGED_PERSONS: FlaggedPerson[] = [
  {
    ...
    flagCategories: [
      { type: "watchlist", label: "Watchlist Match",    labelAr: "تطابق قائمة المراقبة", color: "#C94A5E", detail: "Interpol Red Notice — Financial Crimes Unit, Case #IC-2024-8821",       detailAr: "نشرة إنتربول حمراء — وحدة الجرائم المالية، القضية #IC-2024-8821" },
    ...
    timeline: [
      ...
      { id: "t2",  stream: "Financial",   streamAr: "المالية",      icon: "ri-bank-card-line",       color: "#C94A5E", event: "Wire Transfer",          eventAr: "تحويل بنكي",          detail: "OMR 45,000 → HSBC London — Flagged jurisdiction",        detailAr: "45,000 ر.ع → HSBC لندن — دولة مُبلَّغة",              timestamp: "13:15:22", ref: "PAY-2026-88234", risk: "flagged" },
      ...
      { id: "t4",  stream: "Financial",   streamAr: "المالية",      icon: "ri-bank-card-line",       color: "#C94A5E", event: "Cash Deposit",           eventAr: "إيداع نقدي",          detail: "OMR 980 — 4th sub-threshold deposit this week",          detailAr: "980 ر.ع — الإيداع الرابع دون الحد هذا الأسبوع",       timestamp: "11:30:05", ref: "PAY-2026-88201", risk: "review"  },
      { id: "t5",  stream: "Transport",   streamAr: "النقل",        icon: "ri-bus-line",             color: "#C98A1B", event: "Taxi Booking",           eventAr: "حجز تاكسي",           detail: "Airport → City Center — 18.4 km, Careem",               detailAr: "المطار → مركز المدينة — 18.4 كم، كريم",               timestamp: "10:55:33", ref: "TRN-2026-55234", risk: "clear"   },
    ...
    scoreBreakdown: [
      { stream: "Financial",  streamAr: "المالية",      icon: "ri-bank-card-line",     color: "#C94A5E", weight: 8, rawScore: 92, contribution: 29.4, multiplier: 2.5, multiplierReason: "Wire to high-risk jurisdiction" },
      ...
      { stream: "Transport",  streamAr: "النقل",        icon: "ri-bus-line",           color: "#C98A1B", weight: 3, rawScore: 45, contribution: 4.8,  multiplier: 1.0, multiplierReason: undefined },
    ],
    scoreHistory: [
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: "t2",  stream: "Financial",   streamAr: "المالية",      icon: "ri-bank-card-line",       color: "#C94A5E", event: "Large Payment",          eventAr: "دفعة كبيرة",          detail: "OMR 8,500 — single transaction, cash",                  detailAr: "8,500 ر.ع — معاملة واحدة، نقداً",                     timestamp: "14:28:10", ref: "PAY-2026-88220", risk: "review"  },
      { id: "t3",  stream: "Transport",   streamAr: "النقل",        icon: "ri-bus-line",             color: "#C98A1B", event: "Cross-Region Trip",      eventAr: "رحلة بين مناطق",      detail: "Capital → Northern City — 3 trips this week",           detailAr: "العاصمة → المدينة الشمالية — 3 رحلات هذا الأسبوع",    timestamp: "11:15:00", ref: "TRN-2026-55210", risk: "review"  },
      ...
      { id: "t5",  stream: "Hotel",       streamAr: "الفنادق",      icon: "ri-hotel-line",           color: "#D6B47E", event: "Check-In",               eventAr: "تسجيل وصول",          detail: "Grand Muscat Hotel — Room 412, 3 nights",               detailAr: "فندق غراند مسقط — غرفة 412، 3 ليالٍ",                 timestamp: "07:30:00", ref: "HTL-2026-22100", risk: "clear"   },
    ...
    scoreBreakdown: [
      ...
      { stream: "Financial",  streamAr: "المالية",   icon: "ri-bank-card-line",     color: "#C94A5E", weight: 8, rawScore: 65, contribution: 18.6, multiplier: 1.5, multiplierReason: "Cash deposit > 5,000" },
      { stream: "Transport",  streamAr: "النقل",     icon: "ri-bus-line",           color: "#C98A1B", weight: 3, rawScore: 55, contribution: 5.9,  multiplier: 1.0, multiplierReason: undefined },
  ...
  },
  {
    ...
    flagCategories: [
      { type: "overstay",  label: "Overstay",         labelAr: "تجاوز مدة الإقامة", color: "#C98A1B", detail: "Visa expired 3 days ago — no exit record in border system",  detailAr: "انتهت التأشيرة منذ 3 أيام — لا سجل خروج في نظام الحدود" },
    ...
    timeline: [
      ...
      { id: "t3",  stream: "Hotel",       streamAr: "الفنادق",      icon: "ri-hotel-line",           color: "#D6B47E", event: "No Registration",        eventAr: "لا تسجيل فندقي",      detail: "No hotel record since entry — 33 days",                 detailAr: "لا سجل فندقي منذ الدخول — 33 يوماً",                  timestamp: "2026-01-01", ref: "HTL-NONE", risk: "flagged" },
      { id: "t4",  stream: "Transport",   streamAr: "النقل",        icon: "ri-bus-line",             color: "#C98A1B", event: "Bus Trip",               eventAr: "رحلة حافلة",          detail: "City Center → Industrial Area — 3 trips",               detailAr: "مركز المدينة → المنطقة الصناعية — 3 رحلات",            timestamp: "10:00:00", ref: "TRN-2026-55188", risk: "review"  },
    ...
    scoreBreakdown: [
      ...
      { stream: "Hotel",   streamAr: "الفنادق",   icon: "ri-hotel-line",    color: "#D6B47E", weight: 3, rawScore: 80, contribution: 8.6,  multiplier: 1.0, multiplierReason: undefined },
    ],
    scoreHistory: [
  ...
  },
  {
    ...
    flagCategories: [
      ...
      { type: "overstay",  label: "Overstay Risk",    labelAr: "خطر تجاوز الإقامة", color: "#C98A1B", detail: "Visa expires in 2 days — no renewal application filed",       detailAr: "التأشيرة تنتهي خلال يومين — لا طلب تجديد مقدم" },
    ],
    matchInfo: {
    ...
    timeline: [
      ...
      { id: "t4",  stream: "Financial",   streamAr: "المالية",      icon: "ri-bank-card-line",       color: "#C94A5E", event: "Account Opened",         eventAr: "فتح حساب",            detail: "Bank Muscat — Savings account, alias name used",        detailAr: "بنك مسقط — حساب توفير، استخدام اسم مستعار",           timestamp: "2025-09-15", ref: "PAY-2025-88100", risk: "review" },
    ...
    scoreBreakdown: [
      ...
      { stream: "Financial",  streamAr: "المالية",   icon: "ri-bank-card-line",     color: "#C94A5E", weight: 8, rawScore: 55, contribution: 13.2, multiplier: 1.0, multiplierReason: undefined },
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: "t4",  stream: "Financial",   streamAr: "المالية",      icon: "ri-bank-card-line",       color: "#C94A5E", event: "Cash Withdrawal",        eventAr: "سحب نقدي",            detail: "OMR 2,000 — ATM, Ruwi branch",                          detailAr: "2,000 ر.ع — صراف آلي، فرع الروي",                     timestamp: "06:30:00", ref: "PAY-2026-88188", risk: "clear"   },
    ...
    scoreBreakdown: [
      ...
      { stream: "Financial", streamAr: "المالية",      icon: "ri-bank-card-line",color: "#C94A5E", weight: 8, rawScore: 35, contribution: 7.9,  multiplier: 1.0, multiplierReason: undefined },
