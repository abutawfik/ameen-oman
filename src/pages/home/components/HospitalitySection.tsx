...
const HospitalitySection = () => {
  ...
  return (
    <section className="py-20 md:py-28 relative" style={{ background: "linear-gradient(135deg, #060D1A 0%, #071A0F 50%, #060D1A 100%)" }}>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-full max-w-[480px]">
              <div className="rounded-2xl overflow-hidden border border-green-500/20" style={{ background: "rgba(10,22,40,0.9)" }}>
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[{ label: "Occupied", value: "42", color: "#22D3EE" }, { label: "Available", value: "18", color: "#4ADE80" }, { label: "Check-outs", value: "7", color: "#FACC15" }].map((s) => (
                  ...
                  <div className="space-y-2">
                    {[{ name: "Ahmed Al-Rashidi", room: "204", status: "Check-in", color: "#4ADE80" }, { name: "Sarah Johnson", room: "118", status: "Staying", color: "#22D3EE" }, { name: "Mohammed Al-Balushi", room: "312", status: "Check-out", color: "#FACC15" }].map((g) => (
                      <div key={g.name} className="flex items-center justify-between p-2.5 rounded-lg" style={{ background: "rgba(255,255,255,0.03)" }}>
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 flex items-center justify-center rounded-full bg-cyan-400/10">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <button className="flex items-center gap-2 px-6 py-3 bg-green-400 text-[#060D1A] font-semibold rounded-md hover:bg-green-300 transition-colors duration-200 whitespace-nowrap cursor-pointer text-sm">
