            ...
            {STEPS.map((s, idx) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: isActive ? 'rgba(184,138,60,0.08)' : 'transparent',
                    border: isActive ? '1px solid rgba(184,138,60,0.2)' : '1px solid transparent',
                  }}
                >
                  {/* Step circle */}
                  <div
        ...
        <div className="flex-1 flex items-start justify-center py-10 px-8 overflow-y-auto">
          <div className="w-full max-w-xl">
            ...
            <div
              ...
              style={{ background: 'rgba(10,37,64,0.85)', backdropFilter: 'blur(12px)' }}
            >
              {/* Top accent */}
              <div
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <select value={city} onChange={e => setCity(e.target.value)} className={`${inputCls} cursor-pointer`} style={{ background: 'rgba(10,37,64,0.9)' }}>
                        {CITIES.map(c => <option key={c} value={c} style={{ background: '#0A2540' }}>{c}</option>)}
                      </select>
                    </div>
                    <div>
                  ...
                  {/* Chain toggle */}
                  <div className="rounded-xl border border-gold-500/15 p-4" style={{ background: 'rgba(184,138,60,0.03)' }}>
              ...
              {step === 2 && (
                <div>
                  ...
                  {/* Bulk add */}
                  <div className="rounded-xl border border-gold-500/15 p-4 mb-4" style={{ background: 'rgba(184,138,60,0.03)' }}>
                    ...
                    <div className="flex items-end gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <select value={bulkType} onChange={e => setBulkType(e.target.value)} className={`${inputCls} cursor-pointer`} style={{ background: 'rgba(10,37,64,0.9)' }}>
                          {ROOM_TYPES.map(t => <option key={t} value={t} style={{ background: '#0A2540' }}>{t}</option>)}
                        </select>
                      </div>
                      <button
                        onClick={bulkAdd}
                  ...
                  <div className="space-y-3 max-h-72 overflow-y-auto pr-1">
                    {rooms.map(room => (
                      <div key={room.id} className="rounded-xl border border-gold-500/12 p-3" style={{ background: 'rgba(10,37,64,0.6)' }}>
              ...
              {step === 3 && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-2xl border border-gold-500/20 p-6 text-center" style={{ background: 'rgba(184,138,60,0.03)' }}>
                    <div
              ...
              {step === 4 && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-xl border border-gold-500/20 p-4" style={{ background: 'rgba(184,138,60,0.04)' }}>
                  ...
                  {connStatus === 'failed' && (
                    <div className="rounded-xl p-3 border border-red-500/25 text-sm" style={{ background: 'rgba(201,74,94,0.07)' }}>
