  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: fonts.sans }}>
      ...
      >
        ...
        >
          Al-Ameen Operator Portal · First-Time Setup
        </div>
        <div
          style={{ width: 60, height: 1, background: `linear-gradient(90deg, transparent, ${C.gold400}, transparent)` }}
        />
        <div style={{ color: C.ocean400, fontSize: "0.8rem", textAlign: "center", lineHeight: 1.7, maxWidth: 260 }}>
          <p style={{ margin: "0 0 0.25rem", fontWeight: 600, color: C.gold400, fontSize: "0.78rem" }}>
            Welcome to Al-Ameen
          </p>
          <p style={{ margin: "0 0 1rem", fontSize: "0.76rem" }}>
            Your account has been provisioned. Set a secure password to complete your registration.
          </p>
          {REQS.map(r => (
            <p key={r.label} style={{ margin: "0.2rem 0", fontSize: "0.74rem" }}>· {r.label}</p>
          ))}
        </div>
      </div>
          ...
          {!done ? (
            <>
              ...
              <p style={{ color: C.ivory700, fontSize: "0.875rem", margin: "0 0 2rem" }}>
                This is your first login. Choose a strong password to secure your operator account.
              </p>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: "none", border: "none", cursor: "pointer", color: C.ivory700, fontSize: "1.1rem",
                      }}
                    >
                ...
                {error && <p style={{ color: "#C94A5E", fontSize: "0.8rem", margin: 0 }}>{error}</p>}
            ...
            <div style={{ textAlign: "center", padding: "1rem 0" }}>
              <div
                style={{
                  ...
                  background: "#162F1C", border: "2px solid #4A8E5A",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 1.5rem", fontSize: "1.8rem",
                }}
              >
                <i className="ri-user-follow-line" style={{ color: "#4A8E5A" }} />
              </div>
              ...
              <p style={{ color: C.ivory700, fontSize: "0.875rem", lineHeight: 1.7, marginBottom: "2rem" }}>
                Your Al-Ameen operator account is ready. Log in now to begin.
              </p>
              <button
