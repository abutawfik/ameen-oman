...
const ALL_EVENTS: EventRow[] = [
  ...
  { id: "r12", type: "SIM Deactivation",      typeAr: "إلغاء شريحة",        typeColor: "#C94A5E", ref: "MOB-2025-19230", status: "accepted", person: "Layla Al-Hinai",      docMasked: "***8812", date: "2026-04-04", time: "14:00", amount: "",               branch: "Seeb Branch",         branchAr: "فرع السيب",        detail: "Postpaid SIM deactivated",        detailAr: "إلغاء شريحة مدفوعة",            nationality: "OM", phone: "+968 9567 8901", module: "mobile", operator: "Omantel" },
  ...
  { id: "r17", type: "Overstay Alert",        typeAr: "تنبيه تجاوز",        typeColor: "#C94A5E", ref: "BRD-2025-44888", status: "pending",  person: "Unknown Subject",     docMasked: "***8401", date: "2026-04-04", time: "00:00", amount: "",               branch: "System Alert",        branchAr: "تنبيه النظام",     detail: "Visa expired 3 days ago",         detailAr: "انتهت التأشيرة منذ 3 أيام",      nationality: "PK", phone: "N/A", module: "border", riskLevel: "high" },
...
const STATUS_COLORS: Record<string, string> = { accepted: "#4ADE80", pending: "#FACC15", rejected: "#C94A5E" };
const STATUS_LABELS: Record<string, { en: string; ar: string }> = {
  accepted: { en: "Success", ar: "مقبول" },
  pending:  { en: "Pending", ar: "معلق" },
  rejected: { en: "Failed",  ar: "فاشل" },
};
const RISK_COLORS: Record<string, string> = { low: "#4ADE80", medium: "#FACC15", high: "#C98A1B", critical: "#C94A5E" };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border p-5" style={{ background: "rgba(10,37,64,0.8)", borderColor: "rgba(184,138,60,0.12)", backdropFilter: "blur(12px)" }}>
        <div className="flex flex-wrap items-end gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select value={filterType} onChange={(e) => { setFilterType(e.target.value); setPage(1); }}
              ...
              style={{ background: "rgba(5,20,40,0.8)", borderColor: "rgba(184,138,60,0.15)", color: "#D1D5DB", minWidth: "160px" }}>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select value={filterStatus} onChange={(e) => { setFilterStatus(e.target.value); setPage(1); }}
              className="px-3 py-2 rounded-lg border text-sm cursor-pointer outline-none transition-colors"
              style={{ background: "rgba(5,20,40,0.8)", borderColor: "rgba(184,138,60,0.15)", color: "#D1D5DB", minWidth: "130px" }}>
        ...
        {selectedBulk.length > 0 && (
          <div className="mt-3 flex items-center gap-3 px-4 py-2.5 rounded-xl border"
            style={{ background: "rgba(184,138,60,0.06)", borderColor: "rgba(184,138,60,0.2)" }}>
      ...
      <div className="rounded-2xl border overflow-hidden" style={{ background: "rgba(10,37,64,0.8)", borderColor: "rgba(184,138,60,0.12)", backdropFilter: "blur(12px)" }}>
        ...
        {/* Pagination */}
        <div className="flex items-center justify-between px-6 py-4 border-t" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
      ...
      {selectedRow && (
        <div className="rounded-2xl border overflow-hidden"
          style={{ background: "rgba(5,20,40,0.97)", borderColor: "rgba(184,138,60,0.25)", backdropFilter: "blur(20px)" }}>
          {/* Panel header */}
          <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: "rgba(184,138,60,0.1)", background: "rgba(184,138,60,0.04)" }}>
