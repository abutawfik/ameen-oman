...
const ENTITY_LEGENDS: Record<string, { label: string; labelAr: string; color: string; icon: string }[]> = {
  hotel: [
    { label: "Booking",     labelAr: "حجز",           color: "#22D3EE", icon: "ri-calendar-line" },
  ...
  mobile: [
    ...
    { label: "Roaming",        labelAr: "تجوال",         color: "#22D3EE", icon: "ri-global-line" },
  ],
  municipality: [
    { label: "Lease Start",  labelAr: "بدء إيجار",   color: "#4ADE80", icon: "ri-home-line" },
    { label: "Lease Renew",  labelAr: "تجديد إيجار", color: "#22D3EE", icon: "ri-refresh-line" },
  ...
  financial: [
    ...
    { label: "Account Opened", labelAr: "فتح حساب",       color: "#22D3EE", icon: "ri-bank-card-line" },
  ],
  border: [
    ...
    { label: "Visa Check",    labelAr: "فحص تأشيرة",   color: "#22D3EE", icon: "ri-passport-line" },
  ],
  utility: [
    ...
    { label: "Transfer",       labelAr: "نقل",          color: "#22D3EE", icon: "ri-swap-line" },
  ...
  employment: [
    { label: "Permit Issued",  labelAr: "إصدار تصريح", color: "#22D3EE", icon: "ri-briefcase-line" },
  ...
  ecommerce: [
    ...
    { label: "Shipping Alert", labelAr: "تنبيه شحن",    color: "#22D3EE", icon: "ri-truck-line" },
  ],
  social: [
    ...
    { label: "OSINT Match",    labelAr: "تطابق OSINT",  color: "#22D3EE", icon: "ri-global-line" },
  ],
  default: [
    { label: "Event",     labelAr: "حدث",    color: "#22D3EE", icon: "ri-calendar-line" },
...
const MOCK_EVENTS: CalEvent[] = [
  ...
  { id: "c2",  day: 1,  type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04890", person: "Sarah Johnson",       time: "10:30", status: "accepted", detail: "Suite 512, 3 nights",             detailAr: "جناح 512، 3 ليالٍ",             amount: "OMR 890.000", endDay: 4 },
  ...
  { id: "c5",  day: 5,  type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04887", person: "Khalid Al-Amri",     time: "16:45", status: "pending",  detail: "Extended stay +2 nights",        detailAr: "تمديد الإقامة +2 ليلتين",       amount: "OMR 340.000", endDay: 8 },
  ...
  { id: "c8",  day: 10, type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04884", person: "Priya Nair",         time: "08:30", status: "accepted", detail: "Room 407, 1 night extension",    detailAr: "غرفة 407، تمديد ليلة",          amount: "OMR 120.000", endDay: 12 },
  ...
  { id: "c12", day: 17, type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04880", person: "Nadia Al-Rashidi",   time: "17:00", status: "accepted", detail: "Suite 601, VIP booking",         detailAr: "جناح 601، حجز VIP",             amount: "OMR 2,400.000", endDay: 21 },
  ...
  { id: "c16", day: 24, type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04876", person: "Elena Petrov",       time: "10:00", status: "pending",  detail: "Room 318, 2 nights",            detailAr: "غرفة 318، ليلتان",              amount: "OMR 280.000", endDay: 26 },
  ...
  { id: "c20", day: 6,  type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04893", person: "Hana Yamamoto",      time: "09:00", status: "accepted", detail: "Room 215, 4 nights",             detailAr: "غرفة 215، 4 ليالٍ",             amount: "OMR 520.000", endDay: 10 },
  ...
  { id: "c24", day: 25, type: "Booking",     typeAr: "حجز",          color: "#22D3EE", ref: "HTL-2025-04897", person: "Lena Müller",        time: "11:00", status: "accepted", detail: "Room 307, 5 nights",             detailAr: "غرفة 307، 5 ليالٍ",             amount: "OMR 650.000", endDay: 30 },
...
const CalendarGrid = ({ isAr, entityType }: Props) => {
  ...
  return (
    <div className="rounded-2xl border overflow-hidden" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
      {/* Calendar header */}
      <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
        ...
        <div className="flex items-center gap-3">
          <button type="button" onClick={goToday}
            ...
            style={{ background: "rgba(34,211,238,0.08)", borderColor: "rgba(34,211,238,0.25)", color: "#22D3EE" }}
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center gap-x-5 gap-y-2 px-6 py-3 border-b" style={{ borderColor: "rgba(34,211,238,0.06)", background: "rgba(0,0,0,0.15)" }}>
        {legend.map((l) => (
        ...
        <div className="ml-auto flex items-center gap-4">
          <div className="flex items-center gap-1.5">
            <div className="w-3 h-3 rounded-full border-2 flex-shrink-0" style={{ borderColor: "#22D3EE" }} />
            <span className="text-gray-400 text-xs">{isAr ? "اليوم" : "Today"}</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-8 h-1.5 rounded-full flex-shrink-0" style={{ background: "rgba(34,211,238,0.4)" }} />
      ...
      {/* Day headers */}
      <div className="grid grid-cols-7 border-b" style={{ borderColor: "rgba(34,211,238,0.06)" }}>
      ...
      <div className="grid grid-cols-7">
        {Array.from({ length: firstDay }).map((_, i) => (
          <div key={`empty-${i}`} className="min-h-[100px] border-b border-r" style={{ borderColor: "rgba(34,211,238,0.04)", background: "rgba(0,0,0,0.15)" }} />
        ))}
            ...
            <div key={day}
              ...
              style={{
                ...
                background: isSelected
                  ...
                  : "rgba(10,22,40,0.4)",
                outline: isSelected ? "1px solid rgba(34,211,238,0.3)" : "none",
              }}
              onMouseEnter={(e) => { if (!isSelected) (e.currentTarget as HTMLElement).style.background = "rgba(34,211,238,0.04)"; }}
              onMouseLeave={(e) => { if (!isSelected) (e.currentTarget as HTMLElement).style.background = isToday ? "rgba(34,211,238,0.03)" : "rgba(10,22,40,0.4)"; }}>
              ...
              <div className="flex items-center justify-between mb-1.5">
                <div className={`w-7 h-7 flex items-center justify-center rounded-full text-sm font-bold font-['JetBrains_Mono'] transition-all ${isToday ? "text-black" : "text-white"}`}
                  style={{
                    ...
                    boxShadow: isToday ? "0 0 12px rgba(34,211,238,0.5)" : "none",
                    border: isToday ? "none" : isSelected ? "1px solid rgba(34,211,238,0.4)" : "1px solid transparent",
                  }}>
                  {day}
                </div>
                {hasEvents && (
                  <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#22D3EE", opacity: 0.6 }} />
                )}
              </div>
              ...
              <div className="space-y-0.5">
                ...
                {dayEvents.length > 3 && (
                  <div className="text-center px-1 py-0.5 rounded" style={{ background: "rgba(34,211,238,0.08)", fontSize: "9px", color: "#22D3EE" }}>
      ...
      {/* Day detail popup */}
      {selectedDay && (
        <div className="border-t" style={{ borderColor: "rgba(34,211,238,0.15)" }}>
          <div className="p-6">
            {/* Popup header */}
            ...
            {selectedEvents.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-4">
                {selectedEvents.map((ev) => (
                  <div key={ev.id} className="flex items-start gap-3 p-3 rounded-xl border transition-colors cursor-pointer"
                    style={{ background: "rgba(6,13,26,0.6)", borderColor: `${ev.color}20` }}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {ev.amount && <span className="text-cyan-400 text-xs font-['JetBrains_Mono']">{ev.amount}</span>}
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="flex flex-col items-center justify-center py-8 mb-4 rounded-xl border"
                style={{ background: "rgba(6,13,26,0.4)", borderColor: "rgba(34,211,238,0.08)" }}>
