      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <SectionCard title={isAr ? "تفاصيل المعاملة" : "Transaction Details"} icon="ri-exchange-dollar-line">
          <div className="space-y-4">
            ...
            {/* Exchange visual */}
            <div className="rounded-xl border p-4" style={{ background: "rgba(0,0,0,0.3)", borderColor: "rgba(34,211,238,0.12)" }}>
              <div className="flex items-end gap-3">
                ...
                <div className="flex flex-col items-center pb-2 flex-shrink-0">
                  <div className="w-9 h-9 flex items-center justify-center rounded-full" style={{ background: "rgba(34,211,238,0.12)", border: "1px solid rgba(34,211,238,0.25)" }}>
                    <i className="ri-arrow-left-right-line text-cyan-400 text-sm" />
                  </div>
                </div>
                <div className="flex-1">
