...
const FinConfirmation = ({ refNumber, eventType, isAr, onReset, flagged }: Props) => {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(10,37,64,0.9)", borderColor: flagged ? "rgba(201,74,94,0.3)" : "rgba(184,138,60,0.25)", backdropFilter: "blur(16px)" }}
    >
      {/* Icon */}
      ...
      {/* Flagged badge */}
      {flagged && (
        <div className="flex items-center gap-2 px-4 py-2 rounded-full border mb-4" style={{ background: "rgba(201,74,94,0.08)", borderColor: "rgba(201,74,94,0.3)" }}>
