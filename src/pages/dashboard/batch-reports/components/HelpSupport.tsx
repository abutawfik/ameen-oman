...
const GUIDES = [
  ...
  { icon: "ri-file-text-line",   color: "#22D3EE", title: "API Integration Specification",titleAr: "مواصفات تكامل API",             size: "2.8 MB", type: "PDF" },
  { icon: "ri-file-text-line",   color: "#FACC15", title: "Data Dictionary v2.1",         titleAr: "قاموس البيانات v2.1",           size: "0.9 MB", type: "PDF" },
];

const VIDEOS = [
  { icon: "ri-play-circle-line", color: "#22D3EE", title: "Getting Started with AMEEN",   titleAr: "البدء مع AMEEN",               duration: "8:24" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border overflow-hidden"
        ...
        <div className="flex items-center gap-3 px-6 py-4 border-b" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
          <div className="w-8 h-8 flex items-center justify-center rounded-lg"
            ...
            <i className="ri-question-answer-line text-cyan-400 text-sm" />
          </div>
          ...
          {FAQS.map((faq, i) => (
            <div key={i}>
              <button type="button"
                ...
                style={{ background: openFaq === i ? "rgba(34,211,238,0.04)" : "transparent" }}
                ...
                <i className={`text-cyan-400 text-sm transition-transform flex-shrink-0 ml-4 ${openFaq === i ? "ri-subtract-line" : "ri-add-line"}`} />
              </button>
              {openFaq === i && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border overflow-hidden"
          style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
          <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
            <div className="w-8 h-8 flex items-center justify-center rounded-lg"
              style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
              <i className="ri-book-open-line text-cyan-400 text-sm" />
            </div>
        ...
        <div className="rounded-2xl border overflow-hidden"
          ...
          <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
            <div className="w-8 h-8 flex items-center justify-center rounded-lg"
              style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
              <i className="ri-video-line text-cyan-400 text-sm" />
            </div>
      ...
      <div className="rounded-2xl border p-6"
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="w-8 h-8 flex items-center justify-center rounded-lg"
            style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
            <i className="ri-customer-service-2-line text-cyan-400 text-sm" />
          </div>
          ...
          <form onSubmit={handleTicketSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea value={ticketForm.description} onChange={(e) => setTicketForm((p) => ({ ...p, description: e.target.value }))}
                ...
                className="w-full px-3 py-2 rounded-lg border text-sm outline-none focus:border-cyan-400 transition-colors resize-none"
                style={{ background: "rgba(6,13,26,0.8)", borderColor: "rgba(34,211,238,0.15)", color: "#D1D5DB" }} />
