...
const MarConfirmation = ({ refNumber, eventType, eventCode, color, isAr, onReset }: Props) => {
  ...
  return (
    <div className="rounded-2xl border p-10 flex flex-col items-center text-center" style={{ background: "rgba(10,22,40,0.9)", borderColor: `${color}30`, backdropFilter: "blur(20px)" }}>
      ...
      <div className="flex gap-3">
        ...
        <button type="button" onClick={() => navigate("/dashboard/marine-events")} className="flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold cursor-pointer whitespace-nowrap font-['Inter'] transition-colors" style={{ background: "#22D3EE", color: "#060D1A" }} onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#06B6D4"; }} onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#22D3EE"; }}>
...
export default MarConfirmation;
