...
const EVENT_CARDS = [
  { id: "boat" as EventType, icon: "ri-ship-line", label: "Boat Rental", labelAr: "تأجير قارب", desc: "Register boat rental with marine license, vessel details, passengers and GPS tracker", descAr: "تسجيل تأجير قارب مع رخصة الملاحة وبيانات السفينة والركاب وتتبع GPS", color: "#D4A84B", code: "MAR_BOAT" },
      ...
      <header className="sticky top-0 z-40 flex items-center justify-between px-6 py-3 border-b" style={{ background: "rgba(11,18,32,0.95)", borderColor: "rgba(181,142,60,0.12)", backdropFilter: "blur(12px)" }}>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(181,142,60,0.1)", border: "1px solid rgba(181,142,60,0.2)" }}><i className="ri-anchor-line text-gold-400 text-sm" /></div>
            <div>
              <div className="flex items-center gap-2">
