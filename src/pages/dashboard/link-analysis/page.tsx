...
const COMMUNITY_PALETTE = ["#22D3EE", "#A78BFA", "#4ADE80", "#FB923C", "#F472B6", "#FCD34D"];
...
const LinkAnalysisPage = () => {
  ...
  return (
    <div
      ...
      style={{ background: "#060D1A", fontFamily: "Inter, Cairo, sans-serif" }}
    >
      {/* Top bar */}
      <div
        className="flex items-center gap-3 px-4 py-2.5 border-b flex-shrink-0"
        style={{ background: "rgba(10,22,40,0.98)", borderColor: "rgba(34,211,238,0.12)" }}
      >
        <button
          onClick={() => navigate("/dashboard")}
          className="flex items-center gap-1.5 text-gray-500 hover:text-cyan-400 transition-colors cursor-pointer text-sm"
        >
        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded" style={{ background: "rgba(34,211,238,0.06)", border: "1px solid rgba(34,211,238,0.15)" }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div
          ...
          style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.1)" }}
        >
          <AlgorithmsPanel
            isAr={isAr}
            nodes={nodes}
            ...
            <div className="flex border-b flex-shrink-0" style={{ borderColor: "rgba(34,211,238,0.1)" }}>
              {[
                ...
                <button
                  ...
                  style={{
                    color: rightPanelTab === tab.key ? "#22D3EE" : "#6B7280",
                    borderBottom: rightPanelTab === tab.key ? "2px solid #22D3EE" : "2px solid transparent",
                  }}
                >
      ...
      {toast && (
        <div
          ...
          style={{ background: "rgba(10,22,40,0.95)", border: "1px solid rgba(34,211,238,0.3)", color: "#22D3EE" }}
        >
