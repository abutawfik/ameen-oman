  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "#051428", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        ...
        <div className="flex-shrink-0 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #051428 0%, #0A2540 50%, #051428 100%)", borderBottom: "1px solid rgba(184,138,60,0.12)" }}>
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "radial-gradient(ellipse at 70% 50%, rgba(184,138,60,0.07) 0%, transparent 55%)" }} />
          <div className="relative z-10 px-6 py-6 flex items-center justify-between">
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className="text-2xl font-bold" style={{ color: "#D6B47E", fontFamily: "'Noto Kufi Arabic', 'Arial', sans-serif" }}>أمين</span>
                  <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold font-['JetBrains_Mono']" style={{ background: "rgba(184,138,60,0.1)", color: "#D6B47E", border: "1px solid rgba(184,138,60,0.2)" }}>
                    Brand Identity
                  </span>
                </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-px h-10" style={{ background: "rgba(184,138,60,0.2)" }} />
              <div className="px-3 py-1.5 rounded-lg" style={{ background: "rgba(201,74,94,0.08)", border: "1px solid rgba(201,74,94,0.2)" }}>
        ...
        {/* Tab Content */}
        <div className="flex-1 overflow-y-auto px-6 py-6" style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(184,138,60,0.2) transparent" }}>
          {/* Tab header */}
          <div className="flex items-center gap-2 mb-6 pb-4" style={{ borderBottom: "1px solid rgba(184,138,60,0.08)" }}>
