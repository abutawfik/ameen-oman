  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "#0B1220", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        ...
        <div className="flex-shrink-0 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0B1220 0%, #141D2E 50%, #0B1220 100%)", borderBottom: "1px solid rgba(181,142,60,0.12)" }}>
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "radial-gradient(ellipse at 70% 50%, rgba(181,142,60,0.07) 0%, transparent 55%)" }} />
          <div className="relative z-10 px-6 py-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-px h-10" style={{ background: "rgba(181,142,60,0.2)" }} />
        ...
        {/* Tab Content */}
        <div className="flex-1 overflow-y-auto px-6 py-6" style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(181,142,60,0.2) transparent" }}>
          {/* Tab header */}
          <div className="flex items-center gap-2 mb-6 pb-4" style={{ borderBottom: "1px solid rgba(181,142,60,0.08)" }}>
