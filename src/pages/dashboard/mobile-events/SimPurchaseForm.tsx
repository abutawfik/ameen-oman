      ...
      <SectionCard title={isAr ? "الخدمات الإضافية" : "Additional Services"} icon="ri-settings-3-line">
        ...
        {(intlCalling || dataRoaming || intlSms || mobileMoney) && (
          ...
          >
            ...
            {intlCalling && <span className="px-2 py-0.5 rounded-full text-xs font-semibold font-['Inter']" style={{ background: "rgba(34,211,238,0.12)", color: "#22D3EE", border: "1px solid rgba(34,211,238,0.25)" }}>{isAr ? "مكالمات دولية" : "Intl Calling"}</span>}
            {dataRoaming && <span className="px-2 py-0.5 rounded-full text-xs font-semibold font-['Inter']" style={{ background: "rgba(34,211,238,0.12)", color: "#22D3EE", border: "1px solid rgba(34,211,238,0.25)" }}>{isAr ? "تجوال البيانات" : "Data Roaming"}</span>}
            {intlSms && <span className="px-2 py-0.5 rounded-full text-xs font-semibold font-['Inter']" style={{ background: "rgba(34,211,238,0.12)", color: "#22D3EE", border: "1px solid rgba(34,211,238,0.25)" }}>{isAr ? "رسائل دولية" : "Intl SMS"}</span>}
            {mobileMoney && <span className="px-2 py-0.5 rounded-full text-xs font-semibold font-['Inter']" style={{ background: "rgba(34,211,238,0.12)", color: "#22D3EE", border: "1px solid rgba(34,211,238,0.25)" }}>{isAr ? "محفظة إلكترونية" : "Mobile Money"}</span>}
          </div>
        )}
      </SectionCard>
