...
const PstConfirmation = ({ refNumber, eventType, eventCode, color, isAr, onReset }: Props) => {
  ...
  return (
    <div className="rounded-2xl border p-10 flex flex-col items-center text-center" style={{ background: "rgba(20,29,46,0.9)", borderColor: `${color}30`, backdropFilter: "blur(20px)" }}>
      ...
      <div className="px-8 py-5 rounded-2xl border mb-8 w-full max-w-md" style={{ background: "rgba(181,142,60,0.04)", borderColor: "rgba(181,142,60,0.15)" }}>
        <p className="text-gray-500 text-xs mb-2 uppercase tracking-widest">{isAr ? "رقم المرجع" : "Reference Number"}</p>
        <p className="text-xl font-bold font-['JetBrains_Mono'] tracking-wider mb-1" style={{ color: "#D4A84B" }}>{refNumber}</p>
