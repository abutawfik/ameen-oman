...
const SocialIntelligencePage = () => {
  ...
  const overviewStats = [
    ...
    { label: isAr ? "تنبيهات الكلمات اليوم" : "Keyword Alerts Today", value: "2,785", color: "#C94A5E", icon: "ri-search-eye-line", trend: "+18%" },
    { label: isAr ? "منشورات مُبلَّغة" : "Posts Flagged", value: "67", color: "#FACC15", icon: "ri-flag-line", trend: "+5" },
    { label: isAr ? "تنبيهات مرتفعة" : "Elevated Alerts", value: "3", color: "#C98A1B", icon: "ri-alarm-warning-line", trend: "+1" },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="rounded-2xl border p-6" style={{ background: "rgba(10,37,64,0.8)", borderColor: "rgba(184,138,60,0.2)", backdropFilter: "blur(12px)" }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 flex items-center justify-center rounded-xl" style={{ background: "rgba(184,138,60,0.1)", border: "1px solid rgba(184,138,60,0.25)" }}>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-start gap-3 px-3 py-2 rounded-xl" style={{ background: "rgba(184,138,60,0.04)", border: "1px solid rgba(184,138,60,0.1)" }}>
                      <div className="w-6 h-6 flex items-center justify-center rounded-lg flex-shrink-0" style={{ background: "rgba(184,138,60,0.1)" }}>
              ...
              {/* Tier 2 */}
              <div className="rounded-2xl border p-6" style={{ background: "rgba(10,37,64,0.8)", borderColor: "rgba(250,204,21,0.2)", backdropFilter: "blur(12px)" }}>
                <div className="flex items-center gap-3 mb-4">
