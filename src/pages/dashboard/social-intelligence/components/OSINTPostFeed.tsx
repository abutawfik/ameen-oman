...
const INITIAL_POSTS: Post[] = [
  ...
  { id: "p7", platform: "telegram", handle: "@anonymous_ch_99", content: "ROP checkpoint on highway 1 near Muscat. Avoid if possible.", contentAr: "نقطة تفتيش شرطة عُمان الملكية على الطريق السريع 1 بالقرب من مسقط. تجنبها إن أمكن.", matchedKeywords: ["ROP", "Muscat", "checkpoint"], timestamp: "1.1 hr ago", sentiment: "negative", location: "Muscat Highway", locationAr: "طريق مسقط السريع", elevated: true, elevatedReason: "ROP keyword + checkpoint warning + anonymous account", elevatedReasonAr: "كلمة ROP + تحذير نقطة تفتيش + حساب مجهول", ref: "AMN-OSI-20260405-0097" },
