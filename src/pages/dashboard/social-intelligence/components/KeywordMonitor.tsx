...
const INITIAL_GROUPS: KeywordGroup[] = [
  ...
  { id: "entity", name: "Entity Keywords", nameAr: "كلمات الكيانات", icon: "ri-building-line", color: "#FB923C", keywords: ["ROP", "Ministry", "Palace", "Airport", "Port", "وزارة", "قصر", "مطار", "ميناء"], matchesToday: 567, enabled: true },
