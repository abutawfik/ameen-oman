    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="rounded-xl border p-4" style={{ background: "rgba(10,37,64,0.8)", borderColor: `${s.color}20`, backdropFilter: "blur(12px)" }}>
        ...
        <div className="lg:col-span-2 space-y-3">
          ...
          {groups.map((group) => (
            <div key={group.id} className="rounded-2xl border overflow-hidden transition-all"
              style={{ background: "rgba(10,37,64,0.8)", borderColor: group.enabled ? `${group.color}25` : "rgba(255,255,255,0.06)", backdropFilter: "blur(12px)" }}>
        ...
        <div className="space-y-3">
          ...
          {platforms.map((p) => (
            <div key={p.id} className="rounded-xl border p-4 flex items-center justify-between"
              style={{ background: "rgba(10,37,64,0.8)", borderColor: p.enabled ? `${p.color}20` : "rgba(255,255,255,0.06)", backdropFilter: "blur(12px)" }}>
              <div className="flex items-center gap-3">
          ...
          {/* Refresh interval */}
          <div className="rounded-xl border p-4" style={{ background: "rgba(10,37,64,0.8)", borderColor: "rgba(184,138,60,0.12)", backdropFilter: "blur(12px)" }}>
