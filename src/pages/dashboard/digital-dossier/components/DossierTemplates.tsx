  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-['Inter'] cursor-pointer transition-colors whitespace-nowrap" style={{ background: "rgba(34,211,238,0.08)", color: "#22D3EE", border: "1px solid rgba(34,211,238,0.2)" }}>
        ...
        {dossierTemplates.map((template) => {
          ...
          return (
            ...
            >
              ...
              {/* Footer */}
              <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
                ...
                <button
                  ...
                  style={{ background: "#22D3EE", color: "#060D1A", boxShadow: "0 0 12px rgba(34,211,238,0.2)" }}
                >
