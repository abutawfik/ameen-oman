      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        ...
        <div className="grid grid-cols-5 gap-0 border-b flex-shrink-0" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
          {[
            ...
            <div
              ...
              style={{ borderRight: i < 4 ? "1px solid rgba(184,138,60,0.08)" : "none" }}
            >
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {/* Tabs */}
            <div className="flex items-center gap-1 px-6 py-3 border-b flex-shrink-0" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
              {tabs.map((tab) => (
                <button
                  key={tab.key}
          ...
          <div className="w-72 flex-shrink-0 border-l flex flex-col overflow-hidden" style={{ borderColor: "rgba(184,138,60,0.1)" }}>
            {/* Generation status */}
            {generationState !== "idle" && (
              <div className="p-4 border-b" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
            ...
            <div className="flex-1 overflow-y-auto p-4" style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(184,138,60,0.2) transparent" }}>
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  { stream: "Social Intelligence",icon: "ri-global-line",           color: "#C94A5E", events: 3,  status: "active" },
                  ...
                  { stream: "Healthcare",        icon: "ri-heart-pulse-line",       color: "#C94A5E", events: 0,  status: "no-data" },
