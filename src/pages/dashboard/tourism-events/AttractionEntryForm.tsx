...
const AttractionEntryForm = ({ isAr, onCancel }: Props) => {
  ...
  if (confirmed) return <TorConfirmation refNumber={refNumber} eventType={isAr ? "دخول معلم سياحي" : "Attraction Entry"} eventCode="TOR_ATTRACTION" color="#D6B47E" isAr={isAr} onReset={() => { setConfirmed(false); setAutoFilled(false); }} />;
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        <SectionCard title={isAr ? "معلومات المعلم والزيارة" : "Attraction & Visit Info"} icon="ri-ticket-line" accentColor="#D6B47E">
