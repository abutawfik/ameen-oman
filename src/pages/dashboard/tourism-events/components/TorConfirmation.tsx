        ...
        {steps.map((step, i) => (
          <div key={i} className="flex items-center gap-2">
            <div className="flex flex-col items-center gap-1">
              <div className="w-7 h-7 flex items-center justify-center rounded-full text-xs font-bold" style={{ background: i === 0 ? "rgba(184,138,60,0.2)" : "rgba(255,255,255,0.05)", border: `1px solid ${i === 0 ? "rgba(184,138,60,0.5)" : "rgba(255,255,255,0.1)"}`, color: i === 0 ? "#D6B47E" : "#6B7280" }}>
