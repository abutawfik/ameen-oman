        ...
        {persons.map((p) => {
          ...
          return (
            <button key={p.id} type="button" onClick={() => setSelectedId(p.id)}
              ...
              style={{
                background: isSelected ? `${c}08` : "rgba(10,22,40,0.6)",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border p-5 flex flex-col items-center gap-4"
            style={{ background: "rgba(10,22,40,0.8)", borderColor: `${scoreColor}20`, backdropFilter: "blur(12px)" }}>
          ...
          {/* Score history */}
          <div className="rounded-2xl border p-4" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.1)", backdropFilter: "blur(12px)" }}>
          ...
          <div className="rounded-2xl border p-4" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.1)", backdropFilter: "blur(12px)" }}>
            ...
            <div className="space-y-2">
              {[
                { label: isAr ? "إجمالي الأحداث" : "Total Events",       value: person.timeline.length,                                    color: "#22D3EE", icon: "ri-pulse-line" },
        ...
        <div className="rounded-2xl border p-5" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.1)", backdropFilter: "blur(12px)" }}>
          <div className="flex items-center gap-2 mb-4">
            <i className="ri-bar-chart-2-line text-cyan-400 text-sm" />
          ...
          {/* Total */}
          <div className="mt-5 pt-4 border-t" style={{ borderColor: "rgba(34,211,238,0.08)" }}>
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              <span className="text-xs font-bold font-['JetBrains_Mono'] text-cyan-400">{person.scoreBreakdown.length}</span>
            </div>
            <div className="flex items-center justify-between mt-1">
        ...
        {/* RIGHT: Timeline */}
        <div className="rounded-2xl border p-5 flex flex-col" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.1)", backdropFilter: "blur(12px)" }}>
