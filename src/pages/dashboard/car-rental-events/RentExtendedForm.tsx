        ...
        <SectionCard title={t.insuranceBilling} icon="ri-shield-check-line">
          <div className="space-y-4">
            ...
            <div
              ...
              style={{
                background: additionalInsurance ? "rgba(34,211,238,0.05)" : "rgba(255,255,255,0.02)",
                borderColor: additionalInsurance ? "rgba(34,211,238,0.25)" : "rgba(255,255,255,0.07)",
              }}
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    background: additionalInsurance ? "rgba(34,211,238,0.1)" : "rgba(255,255,255,0.04)",
                    border: `1px solid ${additionalInsurance ? "rgba(34,211,238,0.25)" : "rgba(255,255,255,0.07)"}`,
                  }}
                >
                  <i className={`ri-shield-line text-base ${additionalInsurance ? "text-cyan-400" : "text-gray-600"}`} />
                </div>
                <div>
              ...
              <div
                ...
                style={{ background: additionalInsurance ? "#22D3EE" : "rgba(255,255,255,0.08)" }}
              >
                <div
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: row.highlight ? "#22D3EE" : "#D1D5DB" }}
                    >
                      {row.value}
                    </span>
                  </div>
