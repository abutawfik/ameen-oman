...
const statusConfig = {
  open:          { color: "#C94A5E", bg: "rgba(201,74,94,0.12)", label: "OPEN" },
...
const alertTypeConfig = {
  geofence_breach:   { icon: "ri-map-pin-range-line", color: "#C94A5E", label: "Geofence Breach" },
  cluster_spike:     { icon: "ri-group-line",          color: "#C98A1B", label: "Cluster Spike" },
            ...
            {crossStreamCorrelations.map((corr) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isSelected ? "rgba(184,138,60,0.06)" : "rgba(255,255,255,0.02)",
                    border: `1px solid ${isSelected ? "rgba(184,138,60,0.25)" : "rgba(255,255,255,0.06)"}`,
                  }}
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <span className="text-xs font-['JetBrains_Mono'] font-bold" style={{ color: corr.riskScore >= 80 ? "#C94A5E" : corr.riskScore >= 60 ? "#C98A1B" : "#FACC15" }}>
                        {corr.riskScore}
                      </span>
                    </div>
                  </div>
                  ...
                  <div key={alert.id} className="rounded-xl p-3" style={{ background: "rgba(255,255,255,0.02)", border: `1px solid ${sevCfg.bg}` }}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-['JetBrains_Mono'] px-2 py-0.5 rounded-full"
                        style={{
                          background: alert.status === "new" ? "rgba(201,74,94,0.12)" : alert.status === "acknowledged" ? "rgba(250,204,21,0.12)" : "rgba(74,222,128,0.12)",
                          color: alert.status === "new" ? "#C94A5E" : alert.status === "acknowledged" ? "#FACC15" : "#4ADE80",
                        }}>
      ...
      <div className="flex-1">
        {selectedCorrelation ? (
          <div className="h-full flex flex-col gap-4">
            {/* Header */}
            <div className="rounded-xl p-4" style={{ background: "#0D1B2E", border: "1px solid rgba(184,138,60,0.15)" }}>
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  <div className="text-2xl font-['JetBrains_Mono'] font-bold mb-1"
                    style={{ color: selectedCorrelation.riskScore >= 80 ? "#C94A5E" : selectedCorrelation.riskScore >= 60 ? "#C98A1B" : "#FACC15" }}>
            ...
            {/* Stream timeline */}
            <div className="rounded-xl p-4 flex-1" style={{ background: "#0D1B2E", border: "1px solid rgba(184,138,60,0.1)" }}>
