...
const streamList = [
  ...
  { key: 'transport', label: 'Transport Intel', icon: 'ri-bus-line', color: '#C98A1B' },
  ...
  { key: 'healthcare', label: 'Healthcare Events', icon: 'ri-heart-pulse-line', color: '#C94A5E' },
        ...
        <div className="space-y-4">
          ...
          {nearMatches.length > 0 && (
            <div className="rounded-xl p-4 flex items-center gap-4"
              style={{ background: 'rgba(201,138,27,0.08)', border: '1px solid rgba(201,138,27,0.3)' }}>
              <div className="w-10 h-10 flex items-center justify-center rounded-xl flex-shrink-0"
                style={{ background: 'rgba(201,138,27,0.2)' }}>
            ...
            <div className="rounded-xl p-4"
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label: 'Auto-Escalate if Unacknowledged', labelAr: 'تصعيد تلقائي إذا لم يُقر', state: autoEscalate, set: setAutoEscalate, icon: 'ri-arrow-up-circle-line', color: '#C94A5E' },
                ].map(item => (
              ...
              <div className="grid grid-cols-2 gap-2">
                {streamList.map(stream => (
                  <button key={stream.key} onClick={() => toggleStream(stream.key)}
                    ...
                    style={{
                      background: enabledStreams[stream.key] ? `${stream.color}12` : 'rgba(5,20,40,0.5)',
