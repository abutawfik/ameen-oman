...
const typeConfig: Record<WatchlistType, { label: string; labelAr: string; border: string; bg: string; icon: string }> = {
  national_security: { label: 'National Security', labelAr: 'الأمن الوطني', border: '#F87171', bg: 'rgba(248,113,113,0.08)', icon: 'ri-shield-cross-line' },
  overstay:          { label: 'Overstay Monitoring', labelAr: 'مراقبة تجاوز الإقامة', border: '#FB923C', bg: 'rgba(251,146,60,0.08)', icon: 'ri-time-line' },
