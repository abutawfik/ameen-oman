  ...
  return (
    <div className="rounded-2xl border overflow-hidden" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.15)", backdropFilter: "blur(12px)" }}>
      <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: "rgba(34,211,238,0.1)" }}>
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
            <i className="ri-map-pin-2-line text-cyan-400 text-sm" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          {[
            { type: "air", label: isAr ? "جوي" : "Air", color: "#22D3EE" },
      ...
      <div className="flex flex-col lg:flex-row">
        {/* Map area */}
        <div className="relative flex-1 min-h-[340px]" style={{ background: "rgba(6,13,26,0.6)" }}>
          ...
          {/* Oman shape hint */}
          <div className="absolute inset-4 rounded-2xl opacity-10" style={{ background: "linear-gradient(135deg, rgba(34,211,238,0.3) 0%, transparent 60%)", border: "1px solid rgba(34,211,238,0.2)" }} />
        ...
        {/* Side panel */}
        <div className="w-full lg:w-72 border-t lg:border-t-0 lg:border-l overflow-y-auto" style={{ borderColor: "rgba(34,211,238,0.1)", maxHeight: "340px" }}>
          {selected ? (
            <div className="p-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { label: isAr ? "المغادرة" : "Departures", value: selected.departures, color: "#22D3EE" },
