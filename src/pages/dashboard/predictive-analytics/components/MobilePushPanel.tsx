      ...
      >
        <div className="flex items-start gap-4 mb-4">
          <div
            ...
            style={{ background: 'rgba(184,138,60,0.15)', border: '1px solid rgba(184,138,60,0.3)' }}
          >
          ...
          return (
            <div
              ...
              style={{
                ...
                borderColor: isAcked ? 'rgba(74,222,128,0.3)' : 'rgba(201,74,94,0.3)',
            ...
            >
              ...
              <div
                ...
                style={{
                  background: isAcked ? 'rgba(74,222,128,0.06)' : 'rgba(201,74,94,0.08)',
                  borderColor: isAcked ? 'rgba(74,222,128,0.2)' : 'rgba(201,74,94,0.2)',
                }}
              >
                <div
                  className="w-5 h-5 rounded flex items-center justify-center shrink-0"
                  style={{ background: isAcked ? '#4ADE80' : '#C94A5E' }}
                >
                  <i
                ...
                <span
                  ...
                  style={{ color: isAcked ? '#4ADE80' : '#C94A5E' }}
                >
              ...
              <div className="p-4">
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div
                    ...
                    style={{
                      borderColor: alert.score >= 80 ? '#C94A5E' : '#C98A1B',
                      color: alert.score >= 80 ? '#C94A5E' : '#C98A1B',
                      background: alert.score >= 80 ? 'rgba(201,74,94,0.1)' : 'rgba(201,138,27,0.1)',
                    }}
                  >
                    {alert.score}
                  </div>
                ...
                <div
                  ...
                  style={{ background: 'rgba(201,138,27,0.06)' }}
                >
