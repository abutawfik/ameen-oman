...
const HltConfirmation = ({ refNumber, eventType, eventCode, color, isAr, onReset }: Props) => {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(10,22,40,0.9)", borderColor: `${color}30`, backdropFilter: "blur(20px)" }}
    >
      <div className="relative mb-6">
        <div
          className="w-24 h-24 flex items-center justify-center rounded-full"
          style={{ background: `${color}10`, border: `2px solid ${color}40`, boxShadow: `0 0 40px ${color}18` }}
        >
...
export default HltConfirmation;
