...
const EVENT_CARDS = [
  { id: "patient" as EventType, icon: "ri-clipboard-line", label: "Patient Registration", labelAr: "تسجيل مريض", desc: "Register new patient with identity, insurance and emergency contact details", descAr: "تسجيل مريض جديد مع الهوية والتأمين وجهة الاتصال الطارئة", color: "#C94A5E", code: "HLT_PATIENT" },
  { id: "emergency" as EventType, icon: "ri-heart-pulse-line", label: "Emergency Visit", labelAr: "زيارة طارئة", desc: "Record emergency admission with triage level, arrival mode and discharge status", descAr: "تسجيل دخول طارئ مع مستوى الفرز وطريقة الوصول وحالة الخروج", color: "#C98A1B", code: "HLT_EMERGENCY" },
      ...
      <header className="sticky top-0 z-40 flex items-center justify-between px-6 py-3 border-b" style={{ background: "rgba(5,20,40,0.95)", borderColor: "rgba(184,138,60,0.12)", backdropFilter: "blur(12px)" }}>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(201,74,94,0.1)", border: "1px solid rgba(201,74,94,0.2)" }}>
