    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-5 gap-3">
        {[
          ...
          { label: "Avg Compliance", labelAr: "متوسط الامتثال", value: `${stats.avgCompliance}%`, color: "#C98A1B" },
        ].map((s) => (
      ...
      <div className="flex gap-5">
        ...
        <div className="w-80 flex-shrink-0 space-y-3">
          ...
          <div className="flex gap-2">
            <div className="flex-1 flex items-center gap-2 px-3 py-2 rounded-lg" style={{ background: "rgba(10,37,64,0.8)", border: "1px solid rgba(184,138,60,0.1)" }}>
          ...
          <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1">
            {filtered.map((broker) => (
              <button key={broker.id} onClick={() => setSelectedBroker(broker)}
                ...
                style={{
                  background: selectedBroker.id === broker.id ? "rgba(184,138,60,0.08)" : "rgba(10,37,64,0.6)",
                  border: `1px solid ${selectedBroker.id === broker.id ? "rgba(184,138,60,0.25)" : "rgba(255,255,255,0.05)"}`,
                }}>
        ...
        <div className="flex-1 space-y-4">
          ...
          {selectedBroker.suspended && (
            <div className="flex items-start gap-3 p-4 rounded-xl" style={{ background: "rgba(201,74,94,0.08)", border: "1px solid rgba(201,74,94,0.3)" }}>
              <div className="w-8 h-8 flex items-center justify-center rounded-lg flex-shrink-0" style={{ background: "rgba(201,74,94,0.15)" }}>
              ...
              {selectedBroker.complianceHistory.map((score, i) => (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full rounded-t-sm" style={{
                    height: `${score}%`,
                    background: score >= 90 ? "rgba(74,222,128,0.7)" : score >= 70 ? "rgba(250,204,21,0.7)" : "rgba(201,74,94,0.7)",
                    minHeight: "4px",
                  }} />
      ...
      {showSuspendModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: "rgba(0,0,0,0.7)" }}>
          <div className="w-[480px] rounded-2xl p-6" style={{ background: "rgba(10,37,64,0.98)", border: "1px solid rgba(201,74,94,0.3)" }}>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 flex items-center justify-center rounded-xl" style={{ background: "rgba(201,74,94,0.15)" }}>
