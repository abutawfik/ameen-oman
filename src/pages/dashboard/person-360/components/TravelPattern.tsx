    ...
    >
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        ...
        <button
          ...
          style={{ background: "#22D3EE", color: "#060D1A", boxShadow: "0 0 20px rgba(34,211,238,0.3)" }}
        >
      ...
      <div className="flex gap-5 flex-col lg:flex-row">
        ...
        <div
          ...
          style={{ background: "rgba(6,13,26,0.8)", border: "1px solid rgba(34,211,238,0.1)", minHeight: "340px" }}
        >
          {/* Map background */}
          <img
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 600 340" preserveAspectRatio="none">
            ...
            {[
              ...
              { x: 370, y: 130, seq: 2, color: "#22D3EE" },
              { x: 360, y: 140, seq: 3, color: "#22D3EE" },
              { x: 380, y: 120, seq: 4, color: "#FB923C" },
              { x: 340, y: 80,  seq: 5, color: "#FACC15" },
              { x: 355, y: 125, seq: 6, color: "#67E8F9" },
              { x: 355, y: 128, seq: 7, color: "#FCD34D" },
              { x: 375, y: 138, seq: 8, color: "#22D3EE" },
          ...
          <div className="absolute bottom-3 left-3 flex gap-2">
            {[
              { label: isAr ? "محطات" : "Stops", value: stops.length, color: "#22D3EE" },
              { label: isAr ? "كم" : "km", value: `~${totalDistance}`, color: "#FACC15" },
            ].map(s => (
              <div
                key={s.label}
                className="px-2 py-1 rounded text-[10px] font-['JetBrains_Mono']"
                style={{ background: "rgba(6,13,26,0.85)", color: s.color, border: `1px solid ${s.color}30` }}
              >
