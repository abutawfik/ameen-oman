            ...
            >
              ...
              <div className="flex items-center">
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold font-['Inter']"
                  style={{ background: stream.status === "active" ? "rgba(74,222,128,0.12)" : "rgba(248,113,113,0.12)", color: stream.status === "active" ? "#4ADE80" : "#F87171" }}>
              ...
              <div className="px-4 pb-5 pt-3" style={{ background: "rgba(34,211,238,0.02)", borderTop: "1px solid rgba(34,211,238,0.08)" }}>
                ...
                <div className="flex items-center gap-2 mt-4 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.04)" }}>
                  ...
                  <div className="ml-auto flex items-center gap-1.5">
                    <div className="w-2 h-2 rounded-full" style={{ background: stream.status === "active" ? "#4ADE80" : "#F87171" }} />
                    <span className="text-xs font-['JetBrains_Mono']" style={{ color: stream.status === "active" ? "#4ADE80" : "#F87171" }}>
