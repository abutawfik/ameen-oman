...
const TransportLiveCounters = ({ isAr }: Props) => {
  ...
  const stats = [
    { label: isAr ? "رحلات الحافلات اليوم" : "Bus Journeys Today", sub: isAr ? "شركة الحافلات الوطنية" : "National Bus Co.", value: busTrips, icon: "ri-bus-line", color: "#22D3EE", trend: "+6%" },
