...
const EVENT_CARDS: EventCard[] = [
  {
    ...
    color: "#22D3EE", bgColor: "rgba(34,211,238,0.08)", borderColor: "rgba(34,211,238,0.25)",
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
              <i className="ri-briefcase-line text-cyan-400 text-sm" />
            </div>
            <div>
              <div className="flex items-center gap-2">
          ...
          <>
            ...
            <div className="rounded-2xl border p-5" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
                  <i className="ri-government-line text-cyan-400 text-sm" />
                </div>
                <h3 className="text-white font-bold text-sm">{isAr ? "مصادر البيانات" : "Data Sources"}</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { icon: "ri-government-line", color: "#22D3EE", title: isAr ? "وزارة العمل" : "Ministry of Labour", desc: isAr ? "تغذية API لإصدار/تجديد/إلغاء تصاريح العمل" : "API feed for work permit issuance/renewal/cancellation" },
