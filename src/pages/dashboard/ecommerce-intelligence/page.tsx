...
const EcommerceIntelligencePage = () => {
  ...
  const TABS: { id: Tab; icon: string; label: string; labelAr: string; badge?: string; badgeColor?: string }[] = [
    ...
    { id: "submit",     icon: "ri-add-circle-line",           label: "Record Event",       labelAr: "تسجيل حدث",       badge: "5",  badgeColor: "#22D3EE" },
  ];
          ...
          <>
            ...
            <div className="rounded-2xl border p-5" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  { icon: "ri-map-pin-line", color: "#22D3EE", title: isAr ? "تحديد الموقع الفعلي" : "Actual Location Reveal", desc: isAr ? "الشراء من متجر في نزوى يُثبت الوجود الجسدي — يتعارض مع العنوان المُسجَّل" : "Purchase at Nizwa store proves physical presence — contradicts registered address" },
            ...
            <div className="rounded-2xl border p-5" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  { icon: "ri-exchange-line", color: "#22D3EE", label: isAr ? "نمط الدفع" : "Payment Pattern", desc: isAr ? "بطاقات متعددة، معاملات صغيرة متكررة، تجزئة" : "Multiple cards, frequent small transactions, structuring" },
            ...
            <div className="rounded-2xl border p-5" style={{ background: "rgba(10,22,40,0.8)", borderColor: "rgba(34,211,238,0.12)", backdropFilter: "blur(12px)" }}>
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 flex items-center justify-center rounded-lg" style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
                    <i className="ri-bar-chart-line text-cyan-400 text-sm" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  {[{ label: "Bulk", color: "#FACC15" }, { label: "Restricted", color: "#F87171" }, { label: "High-Value", color: "#FB923C" }, { label: "Pattern", color: "#22D3EE" }].map((l) => (
