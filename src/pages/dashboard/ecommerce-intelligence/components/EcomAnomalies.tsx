  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          {anomalies.map((anomaly) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? `${rc}08` : "rgba(10,37,64,0.8)",
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex flex-col items-end gap-2 flex-shrink-0">
                    <span className="px-2 py-0.5 rounded-full text-xs font-bold"
                      style={{
                        background: anomaly.status === "resolved" ? "rgba(74,222,128,0.12)" : anomaly.status === "investigating" ? "rgba(250,204,21,0.12)" : "rgba(201,74,94,0.12)",
                        color: anomaly.status === "resolved" ? "#4ADE80" : anomaly.status === "investigating" ? "#FACC15" : "#C94A5E",
                        fontSize: "9px",
                      }}>
        ...
        {/* Detail panel */}
        {selectedAnomaly ? (
          <div className="rounded-2xl border p-5 space-y-4" style={{ background: "rgba(10,37,64,0.9)", borderColor: `${riskColor(selectedAnomaly.severity)}30`, backdropFilter: "blur(16px)" }}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                {STATUS_FLOW.map((s) => {
                  ...
                  const sc = s === "resolved" ? "#4ADE80" : s === "investigating" ? "#FACC15" : "#C94A5E";
                  return (
          ...
          <div className="rounded-2xl border flex items-center justify-center" style={{ background: "rgba(10,37,64,0.5)", borderColor: "rgba(184,138,60,0.08)", minHeight: "300px" }}>
            <div className="text-center">
              <div className="w-12 h-12 flex items-center justify-center rounded-2xl mx-auto mb-3" style={{ background: "rgba(184,138,60,0.08)", border: "1px solid rgba(184,138,60,0.15)" }}>
