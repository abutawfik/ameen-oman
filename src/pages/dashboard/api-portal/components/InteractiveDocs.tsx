...
const InteractiveDocs = () => {
  ...
  return (
    <div className="flex gap-4 h-full" style={{ minHeight: "700px" }}>
      {/* Left: Endpoint Tree */}
      <div className="w-64 flex-shrink-0 rounded-xl overflow-hidden" style={{ background: "rgba(10,37,64,0.8)", border: "1px solid rgba(184,138,60,0.12)" }}>
        {/* Search */}
        ...
        {/* Category filters */}
        <div className="p-2 border-b flex flex-wrap gap-1" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
          {categories.map((c) => (
      ...
      <div className="flex-1 min-w-0 space-y-4">
        ...
        <div className="rounded-xl overflow-hidden" style={{ background: "rgba(10,37,64,0.8)", border: "1px solid rgba(184,138,60,0.12)" }}>
          <div className="flex border-b" style={{ borderColor: "rgba(184,138,60,0.08)" }}>
