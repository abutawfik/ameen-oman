        ...
        <div className="px-6 pt-5 pb-0 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="px-3 py-1.5 rounded-lg" style={{ background: "rgba(181,142,60,0.06)", border: "1px solid rgba(181,142,60,0.15)" }}>
              ...
              >
                ...
                {tab.badge && (
                  <span className="px-1.5 py-0.5 rounded-full text-xs font-bold font-['JetBrains_Mono']"
                    style={{ background: "rgba(181,142,60,0.15)", color: "#D4A84B", fontSize: "10px" }}>
                    {tab.badge}
                  </span>
                )}
              </button>
