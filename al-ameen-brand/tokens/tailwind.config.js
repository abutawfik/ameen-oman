/**
 * AL-AMEEN · Tailwind Config · v1.0
 * -------------------------------------------------------------
 * Drop into your project root. Replace or merge with the
 * existing tailwind.config.{js,ts,mjs}. All values mirror the
 * CSS variables in tokens.css so designers and engineers share
 * one source of truth.
 *
 * Arabic/Latin font pairing + semantic risk + category colors
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        arabic:  ['Readex Pro', 'Tajawal', 'IBM Plex Sans Arabic', 'Noto Sans Arabic', 'sans-serif'],
